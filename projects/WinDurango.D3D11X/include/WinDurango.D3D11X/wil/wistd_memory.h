...
namespace wistd // ("Windows Implementation" std)
{
    ...
    struct __compressed_pair_elem
    {
        ...
        template <class _Up,
                  class = typename enable_if<!is_same<__compressed_pair_elem, typename decay<_Up>::type>::value>::type>
        __WI_LIBCPP_INLINE_VISIBILITY constexpr explicit __compressed_pair_elem(_Up &&__u)
                                                      ...
                                                      private __compressed_pair_elem<_T2, 1>
    {
      ...
      public:
        ...
        template <class _Tp,
                  typename enable_if<!is_same<typename decay<_Tp>::type, __compressed_pair>::value, bool>::type = true>
        __WI_LIBCPP_INLINE_VISIBILITY constexpr explicit __compressed_pair(_Tp &&__t)
        ...
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY typename _Base1::const_reference first() const
            WI_NOEXCEPT
        {
        ...
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY typename _Base2::const_reference second() const
            WI_NOEXCEPT
        {
    ...
    template <class _T1, class _T2>
    inline __WI_LIBCPP_INLINE_VISIBILITY void swap_wil(__compressed_pair<_T1, _T2> &__x,
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS default_delete
    {
        ...
        __WI_LIBCPP_INLINE_VISIBILITY default_delete(
            ...
            typename enable_if<is_convertible<_Up *, _Tp *>::value>::type * = nullptr) WI_NOEXCEPT
        {
        }
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS default_delete<_Tp[]>
    {
      private:
      ...
      public:
        ...
        template <class _Up>
        __WI_LIBCPP_INLINE_VISIBILITY default_delete(const default_delete<_Up[]> &,
    ...
    template <class _Tp, class _Dp = default_delete<_Tp>> class __WI_LIBCPP_TEMPLATE_VIS unique_ptr
    {
      public:
      ...
      public:
        ...
        __WI_LIBCPP_INLINE_VISIBILITY unique_ptr(pointer __p, _GoodRValRefType<_Dummy> __d) WI_NOEXCEPT
      ...
      public:
        ...
        __WI_LIBCPP_INLINE_VISIBILITY
            typename enable_if<!is_array<_Up>::value &&
        ...
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY typename add_lvalue_reference<_Tp>::type
        operator*() const
        {
            return *__ptr_.first();
        }
        ...
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY const deleter_type &get_deleter() const
            WI_NOEXCEPT
        {
            return __ptr_.second();
        }
    ...
    template <class _Tp, class _Dp> class __WI_LIBCPP_TEMPLATE_VIS unique_ptr<_Tp[], _Dp>
    {
      public:
        using element_type = _Tp;
        using deleter_type = _Dp;
      ...
      private:
        ...
        template <class _From> struct _CheckArrayPointerConversion : is_same<_From, pointer>
        {
        };
      ...
      public:
        ...
        template <class _Pp, bool _Dummy = true, class = _EnableIfDeleterConstructible<_GoodRValRefType<_Dummy>>,
                  class = _EnableIfPointerConvertible<_Pp>>
        __WI_LIBCPP_INLINE_VISIBILITY unique_ptr(_Pp __p, _GoodRValRefType<_Dummy> __d) WI_NOEXCEPT
            : __ptr_(__p, wistd::move(__d))
        {
            static_assert(!is_reference<deleter_type>::value, "rvalue deleter bound to reference");
        }
        ...
        template <bool _Dummy = true, class = _EnableIfDeleterConstructible<_GoodRValRefType<_Dummy>>>
        __WI_LIBCPP_INLINE_VISIBILITY unique_ptr(nullptr_t, _GoodRValRefType<_Dummy> __d) WI_NOEXCEPT
      ...
      public:
        ...
        template <class _Pp>
        __WI_LIBCPP_INLINE_VISIBILITY typename enable_if<_CheckArrayPointerConversion<_Pp>::value>::type reset(_Pp __p)
            WI_NOEXCEPT
        {
            pointer __tmp = __ptr_.first();
            __ptr_.first() = __p;
    ...
    inline __WI_LIBCPP_INLINE_VISIBILITY bool operator==(const unique_ptr<_T1, _D1> &__x,
