...
//*********************************************************
//! @file
//! Defines a series of macros and types that simplify authoring and consumption of tracelogging, telemetry, and
//! activities.
...
#define __TRACELOGGING_DEFINE_PROVIDER_STORAGE_LINK(name1, name2)                                                      \
    __annotation(L"_TlgProviderLink:|" _wiltlg_LSTRINGIZE(__LINE__) L"|Key|" _wiltlg_LSTRINGIZE(                       \
        name1) L"=" _wiltlg_LSTRINGIZE(name2))
...
#define __RESULT_TELEMETRY_COMMON_FAILURE_PARAMS(failure)                                                              \
    TraceLoggingUInt32((failure).hr, "hresult", "Failure error code"),                                                 \
        ...
        TraceLoggingUInt32((failure).uLineNumber, "lineNumber",                                                        \
                           "Line number within the source code file where the error occurred"),                        \
        TraceLoggingString((failure).pszModule, "module", "Name of the binary where the error occurred"),              \
        TraceLoggingUInt32(                                                                                            \
            static_cast<DWORD>((failure).type), "failureType",                                                         \
        ...
        TraceLoggingWideString((failure).pszMessage, "message",                                                        \
                               "Custom message associated with the failure (if any)"),                                 \
        ...
        TraceLoggingWideString(                                                                                        \
            (failure).callContextOriginating.contextMessage, "originatingContextMessage",                              \
        ...
        TraceLoggingUInt32((failure).callContextCurrent.contextId, "currentContextId",                                 \
                           "Identifier for the newest telemetry activity containing this error"),                      \
        TraceLoggingString((failure).callContextCurrent.contextName, "currentContextName",                             \
                           "Name of the newest telemetry activity containing this error"),                             \
        TraceLoggingWideString(                                                                                        \
            (failure).callContextCurrent.contextMessage, "currentContextMessage",                                      \
...
#define __RESULT_TRACELOGGING_COMMON_FAILURE_PARAMS(failure)                                                           \
    __RESULT_TELEMETRY_COMMON_FAILURE_PARAMS(failure),                                                                 \
        TraceLoggingUInt32(static_cast<DWORD>((failure).failureId), "failureId",                                       \
                           "Identifier assigned to this failure"),                                                     \
        TraceLoggingUInt32(static_cast<DWORD>((failure).cFailureCount), "failureCount",                                \
                           "Number of failures seen within the binary where the error occurred"),                      \
...
#define __ACTIVITY_FAILURE_TELEMETRY_PARAMS(hr, contextName, contextMessage)                                           \
    TelemetryPrivacyDataTag(PDT_ProductAndServicePerformance), TraceLoggingStruct(4, "wilActivity"),                   \
        ...
        TraceLoggingWideString(contextMessage, "currentContextMessage",                                                \
                               "Custom message for the activity containing this error (if any)")
...
namespace wil
{
    ...
    template <typename ActivityTraceLoggingType, ActivityOptions options, UINT64 keyword, UINT8 level,
              UINT64 privacyTag, typename TlgReflectorTag>
    class ActivityBase;
    ...
    namespace details
    {
        ...
        template <class T> class static_lazy
        {
          public:
        ...
        class StoredCallContextInfo : public wil::CallContextInfo
        {
          public:
            ...
            StoredCallContextInfo(PCSTR staticContextName, _Printf_format_string_ PCSTR formatString,
                                  va_list argList) WI_NOEXCEPT : StoredCallContextInfo(staticContextName)
            {
        ...
        template <typename TActivity> void SetRelatedActivityId(TActivity &)
        {
        }
        ...
        void SetRelatedActivityId(
            wil::ActivityBase<ActivityTraceLoggingType, options, keyword, level, privacyTag, TlgReflectorTag> &activity)
        {
    ...
    class ActivityThreadWatcher
    {
      public:
        ...
        ActivityThreadWatcher(_In_ details::IFailureCallback *pCallback, PCSTR staticContextName,
                              _Printf_format_string_ PCSTR formatString, va_list argList) WI_NOEXCEPT
        ...
        ActivityThreadWatcher(_In_ details::IFailureCallback *pCallback,
    ...
    class TraceLoggingProvider : public details::IFailureCallback
    {
      ...
      protected:
        ...
        WI_NODISCARD bool IsEnabled_(UCHAR eventLevel /* WINEVENT_LEVEL_XXX, e.g. WINEVENT_LEVEL_VERBOSE */,
                                     ULONGLONG eventKeywords /* MICROSOFT_KEYWORD_XXX */) const WI_NOEXCEPT
        {
            return ((m_providerHandle != nullptr) &&
                    TraceLoggingProviderEnabled(m_providerHandle, eventLevel, eventKeywords)) ||
        ...
        void ReportTelemetryFailure(FailureInfo const &failure) WI_NOEXCEPT
        {
            ...
            TraceLoggingWrite(m_providerHandle, "FallbackError",
                              TelemetryPrivacyDataTag(PDT_ProductAndServicePerformance),
                              TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                              __RESULT_TELEMETRY_FAILURE_PARAMS(failure));
        }

        void ReportTraceLoggingFailure(FailureInfo const &failure) WI_NOEXCEPT
        {
            TraceLoggingWrite(m_providerHandle, "FallbackError", TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                              __RESULT_TRACELOGGING_FAILURE_PARAMS(failure));
        }
        ...
        void ReportTraceLoggingError(_In_ _Printf_format_string_ PCSTR formatString, va_list argList) WI_NOEXCEPT
        {
            if (IsEnabled_(WINEVENT_LEVEL_ERROR, 0))
            {
                ...
                TraceLoggingWrite(m_providerHandle, "TraceLoggingError", TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
        ...
        void ReportTraceLoggingMessage(_In_ _Printf_format_string_ PCSTR formatString, va_list argList) WI_NOEXCEPT
        {
            if (IsEnabled_(WINEVENT_LEVEL_VERBOSE, 0))
            {
                wchar_t loggingMessage[2048];
                details::PrintLoggingMessage(loggingMessage, ARRAYSIZE(loggingMessage), formatString, argList);
                TraceLoggingWrite(m_providerHandle, "TraceLoggingInfo", TraceLoggingLevel(WINEVENT_LEVEL_VERBOSE),
                                  TraceLoggingWideString(loggingMessage, "traceLoggingMessage"));
            }
        }
    ...
    template <typename TraceLoggingType, UINT64 keyword = 0, UINT8 level = WINEVENT_LEVEL_VERBOSE,
              typename TlgReflectorTag =
                  _TlgReflectorTag_Param0IsProviderType> // helps TlgReflector understand that this is a wrapper type
    class BasicActivity
        : public _TlgActivityBase<BasicActivity<TraceLoggingType, keyword, level, TlgReflectorTag>, keyword, level>
    {
      ...
      public:
        ...
        */
        template <typename ActivityTy> void SetRelatedActivity(_In_ const ActivityTy &relatedActivity)
        {
    ...
    class BasicThreadActivity
        : public _TlgActivityBase<BasicThreadActivity<TraceLoggingType, keyword, level, TlgReflectorTag>, keyword,
                                  level>
    {
        using BaseTy =
...
#define __WI_TraceLoggingWriteTagged(activity, name, ...)                                                              \
    ...
    {                                                                                                                  \
        _tlgActivityDecl(activity) TraceLoggingWriteActivity(TraceLoggingType::Provider(), (name),                     \
                                                             _tlgActivityRef(activity).Id(), NULL, ##__VA_ARGS__);     \
    }                                                                                                                  \
    while (0)                                                                                                          \
    ...
    template <typename ActivityTraceLoggingType, ActivityOptions options = ActivityOptions::None, UINT64 keyword = 0,
              UINT8 level = WINEVENT_LEVEL_VERBOSE, UINT64 privacyTag = 0,
    ...
    class ActivityBase : public details::IFailureCallback
    {
      public:
        ...
        void Stop(HRESULT hr = S_OK) WI_NOEXCEPT
        {
            ...
            {
                __WI_TraceLoggingWriteTagged(*this, "ActivityIntermediateStop", TraceLoggingKeyword(Keyword),
                                             TelemetryPrivacyDataTag(PDT_ProductAndServicePerformance),
        ...
        bool NotifyFailure(FailureInfo const &failure) WI_NOEXCEPT override
        {
            // We always report errors to the ETW stream, but we hold-back the telemetry keyword if we've already
            // reported this error to this particular telemetry provider.
...
#pragma warning(disable : 6319)
                if (false, WI_IsFlagSet(options, ActivityOptions::TelemetryOnFailure) &&
                               !WasAlreadyReportedToTelemetry(failure.failureId))
                {
                    __WI_TraceLoggingWriteTagged(
                        *this, "ActivityError", TraceLoggingKeyword(Keyword | MICROSOFT_KEYWORD_TELEMETRY),
                        TraceLoggingLevel(WINEVENT_LEVEL_ERROR), __ACTIVITY_ERROR_TELEMETRY_FAILURE_PARAMS(failure));
                }
                else if (false, WI_IsFlagSet(options, ActivityOptions::TraceLoggingOnFailure))
                {
                    __WI_TraceLoggingWriteTagged(*this, "ActivityError", TraceLoggingKeyword(0),
                                                 TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                                                 __ACTIVITY_ERROR_TRACELOGGING_FAILURE_PARAMS(failure));
                }
                else
                {
                    __WI_TraceLoggingWriteTagged(*this, "ActivityError", TraceLoggingKeyword(Keyword),
                                                 TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                                                 __ACTIVITY_ERROR_TRACELOGGING_FAILURE_PARAMS(failure));
                }
#pragma warning(pop)
...
#pragma clang diagnostic pop
        ...
        template <class OtherTy> void SetRelatedActivity(OtherTy const &relatedActivity) WI_NOEXCEPT
        {
            auto lock = LockExclusive();
      ...
      protected:
        ...
        // Locking should not be required on these accessors as we only use this at reporting (which will only happen
        // from the final stop)
      ...
      private:
        ...
        {
            if (FAILED(hr) &&
                WI_AreAllFlagsClear(Keyword, (MICROSOFT_KEYWORD_TELEMETRY | MICROSOFT_KEYWORD_MEASURES |
                ...
                WI_IsFlagSet(options, ActivityOptions::TelemetryOnFailure))
            {
                ...
                if (pFailure != nullptr)
                {
                    ...
                    __WI_TraceLoggingWriteTagged(
                        *this, "ActivityFailure", TraceLoggingKeyword(Keyword | MICROSOFT_KEYWORD_TELEMETRY),
                        TraceLoggingLevel(WINEVENT_LEVEL_ERROR), __ACTIVITY_FAILURE_TELEMETRY_FAILURE_PARAMS(failure));
                }
                else
                {
                    ...
                    __WI_TraceLoggingWriteTagged(
                        *this, "ActivityFailure", TraceLoggingKeyword(Keyword | MICROSOFT_KEYWORD_TELEMETRY),
                        TraceLoggingLevel(WINEVENT_LEVEL_ERROR),
                        __ACTIVITY_FAILURE_TELEMETRY_PARAMS(hr, m_pActivityData->GetCallContext()->contextName,
                                                            m_pActivityData->GetCallContext()->contextMessage));
                }
            }
        ...
        rwlock_release_exclusive_scope_exit LockExclusive() WI_NOEXCEPT
        {
            ...
            return (m_sharedActivityData ? m_sharedActivityData->LockExclusive()
                                         : rwlock_release_exclusive_scope_exit());
        }

        template <typename ActivityTraceLoggingTypeOther,
                  typename TlgReflectorTagOther = _TlgReflectorTag_Param0IsProviderType>
        class ActivityData
            : public _TlgActivityBase<ActivityData<ActivityTraceLoggingTypeOther, TlgReflectorTagOther>, keyword, level>
        {
            using BaseTy =
                _TlgActivityBase<ActivityData<ActivityTraceLoggingTypeOther, TlgReflectorTagOther>, keyword, level>;
            friend BaseTy;
            void OnStarted()
            {
            }
            ...
            // SFINAE dispatching on presence of ActivityTraceLoggingTypeOther::CreateActivityId(_Out_ GUID&
            // childActivityId, _In_opt_ const GUID* relatedActivityId)
          ...
          public:
            ...
            {
                if ((failure.hr != m_failure.GetFailureInfo()
                                       .hr) && // don't replace with the same error (likely propagation up the stack)
                    ((failure.hr != m_result) ||
                     SUCCEEDED(
                         m_result))) // don't replace if we've already got the current explicitly supplied failure code
                {
            ...
            {
                return (FAILED(m_result) && (m_result == m_failure.GetFailureInfo().hr)) ? &m_failure.GetFailureInfo()
                                                                                         : nullptr;
            }
...
#define __WI_TraceLoggingWriteStart(activity, name, ...)                                                               \
    ...
    {                                                                                                                  \
        ...
        static_assert(_tlgActivity_Keyword == (_tlgActivity_Keyword _tlg_FOREACH(_tlgKeywordVal, ##__VA_ARGS__)),      \
        ...
        static_assert(_tlgActivity_Level == (_tlgActivity_Level _tlg_FOREACH(_tlgLevelVal, ##__VA_ARGS__)),            \
        ...
        TraceLoggingWriteActivity(TraceLoggingType::Provider(), (name), _tlgActivityRef(activity).Id(),                \
                                  _tlgActivityRef(activity).zInternalRelatedId(),                                      \
                                  TraceLoggingOpcode(1 /* WINEVENT_OPCODE_START */),                                   \
                                  TraceLoggingKeyword(_tlgActivity_Keyword), TraceLoggingLevel(_tlgActivity_Level),    \
                                  TelemetryPrivacyDataTag(_tlgActivityPrivacyTag),                                     \
                                  TraceLoggingDescription("~^" _wiltlg_LSTRINGIZE(activity) L"^~"), ##__VA_ARGS__);    \
    }                                                                                                                  \
    while (0)                                                                                                          \
...
#define __WI_TraceLoggingWriteStop(activity, name, ...)                                                                \
    ...
    {                                                                                                                  \
        ...
        TraceLoggingWriteActivity(TraceLoggingType::Provider(), (name), _tlgActivityRef(activity).Id(), NULL,          \
...
#define __WRITE_ACTIVITY_STOP(EventId, ...)                                                                            \
    ...
    {                                                                                                                  \
        ...
        auto &failure = *pFailure;                                                                                     \
        if (false, WI_IsAnyFlagSet(Keyword, (MICROSOFT_KEYWORD_TELEMETRY | MICROSOFT_KEYWORD_MEASURES |                \
                                             MICROSOFT_KEYWORD_CRITICAL_DATA)))                                        \
        {                                                                                                              \
            __WI_TraceLoggingWriteStop(*this, #EventId, __ACTIVITY_STOP_TELEMETRY_FAILURE_PARAMS(failure),             \
                                       ##__VA_ARGS__);                                                                 \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
            __WI_TraceLoggingWriteStop(*this, #EventId, __ACTIVITY_STOP_TRACELOGGING_FAILURE_PARAMS(failure),          \
                                       ##__VA_ARGS__);                                                                 \
        }                                                                                                              \
    }                                                                                                                  \
    else                                                                                                               \
...
#define __BEGIN_TRACELOGGING_ACTIVITY_CLASS(ActivityClassName, ...)                                                    \
    ...
    {                                                                                                                  \
      ...
      public:                                                                                                          \
        ...
        template <typename... TArgs> void StopWithResult(HRESULT hr, TArgs &&...args)                                  \
        {                                                                                                              \
            SetStopResult(hr);                                                                                         \
...
#define __IMPLEMENT_ACTIVITY_CLASS(ActivityClassName)                                                                  \
  ...
  public:                                                                                                              \
    ...
    template <typename... TArgs> WI_NODISCARD static ActivityClassName Start(TArgs &&...args)                          \
    {                                                                                                                  \
...
#define __IMPLEMENT_CALLCONTEXT_CLASS(ActivityClassName)                                                               \
  protected:                                                                                                           \
    ActivityClassName(_In_opt_ void **, PCSTR contextName, _In_ _Printf_format_string_ PCSTR formatString,             \
  ...
  public:                                                                                                              \
    ...
    ActivityClassName(PCSTR contextName, _Printf_format_string_ PCSTR formatString, ...) WI_NOEXCEPT                   \
        : ActivityClassName(contextName)                                                                               \
    {                                                                                                                  \
        va_list argList;                                                                                               \
        va_start(argList, formatString);                                                                               \
        GetCallContext()->SetMessage(formatString, argList);                                                           \
    ...
    WI_NODISCARD static ActivityClassName Start(PCSTR contextName, _Printf_format_string_ PCSTR formatString, ...)     \
        WI_NOEXCEPT                                                                                                    \
    {                                                                                                                  \
        va_list argList;                                                                                               \
        va_start(argList, formatString);                                                                               \
...
#define DEFINE_TAGGED_TRACELOGGING_EVENT_CV(EventId, ...)                                                              \
    ...
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(*this, #EventId, _GENERIC_PARTB_FIELDS_ENABLED,                                   \
...
#define DEFINE_TAGGED_TRACELOGGING_EVENT_CV(EventId, ...)                                                              \
    void EventId(PCSTR correlationVector)                                                                              \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(*this, #EventId, TraceLoggingString(correlationVector, "__TlgCV__"),              \
                                     ##__VA_ARGS__);                                                                   \
    }
#endif
    ...
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            ...
            _GENERIC_PARTB_FIELDS_ENABLED, ##__VA_ARGS__);                                                             \
    }
#else
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1(EventId, VarType1, varName1, ...)                                      \
    template <typename T1> void EventId(T1 &&varName1)                                                                 \
...
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1, ...)                                   \
    ...
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
            _GENERIC_PARTB_FIELDS_ENABLED, TraceLoggingString(correlationVector, "__TlgCV__"), ##__VA_ARGS__);         \
    }
#else
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1, ...)                                   \
    template <typename T1> void EventId(T1 &&varName1, PCSTR correlationVector)                                        \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, ...)                                                      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, ...)                                               \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, VarType4, varName4, ...)                                  \
    template <typename T1, typename T2, typename T3, typename T4>                                                      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, ...)                           \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, VarType4, varName4, VarType5, varName5, ...)              \
    template <typename T1, typename T2, typename T3, typename T4, typename T5>                                         \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, ...)       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, VarType4, varName4, VarType5, varName5, VarType6,         \
                                                   varName6, ...)                                                      \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>                            \
    void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,             \
                 PCSTR correlationVector)                                                                              \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,  \
                                                varName7, ...)                                                         \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, VarType4, varName4, VarType5, varName5, VarType6,         \
                                                   varName6, VarType7, varName7, ...)                                  \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>               \
    void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,             \
                 T7 &&varName7, PCSTR correlationVector)                                                               \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,  \
                                                varName7, VarType8, varName8, ...)                                     \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>  \
    void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,             \
                 T7 &&varName7, T8 &&varName8)                                                                         \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,          \
                                                   varName3, VarType4, varName4, VarType5, varName5, VarType6,         \
                                                   varName6, VarType7, varName7, VarType8, varName8, ...)              \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>  \
    void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,             \
                 T7 &&varName7, T8 &&varName8, PCSTR correlationVector)                                                \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,  \
                                                varName7, VarType8, varName8, VarType9, varName9, ...)                 \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,  \
              typename T9>                                                                                             \
    void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,             \
                 T7 &&varName7, T8 &&varName8, T9 &&varName9)                                                          \
    {                                                                                                                  \
        __WI_TraceLoggingWriteTagged(                                                                                  \
            *this, #EventId,                                                                                           \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#define __IMPLEMENT_TRACELOGGING_CLASS_BASE(TraceLoggingClassName, TraceLoggingProviderOwnerClassName)                 \
  public:                                                                                                              \
    ...
    static bool IsEnabled(UCHAR eventLevel = 0 /* WINEVENT_LEVEL_XXX, e.g. WINEVENT_LEVEL_VERBOSE */,                  \
...
#define __IMPLEMENT_TRACELOGGING_CLASS(TraceLoggingClassName, ProviderName, ProviderId)                                \
    __IMPLEMENT_TRACELOGGING_CLASS_WITH_GROUP(TraceLoggingClassName, ProviderName, ProviderId,                         \
                                              TraceLoggingOptionMicrosoftTelemetry())

#define __IMPLEMENT_TRACELOGGING_CLASS_WITH_GROUP_CB(TraceLoggingClassName, ProviderName, ProviderId,                  \
                                                     TraceLoggingOption)                                               \
    __IMPLEMENT_TRACELOGGING_CLASS_BASE(TraceLoggingClassName, TraceLoggingClassName)                                  \
  private:                                                                                                             \
    struct StaticHandle                                                                                                \
    ...
    static VOID NTAPI Callback(_In_ const GUID *SourceId, ULONG ControlCode, UCHAR Level, ULONGLONG MatchAnyKeyword,   \
                               ULONGLONG MatchAllKeyword, _In_opt_ EVENT_FILTER_DESCRIPTOR *FilterData,                \
...
#define DEFINE_TRACELOGGING_EVENT_CV(EventId, ...)                                                                     \
    static void EventId(PCSTR correlationVector)                                                                       \
    {                                                                                                                  \
        TraceLoggingWrite(TraceLoggingType::Provider(), #EventId, TraceLoggingString(correlationVector, "__TlgCV__"),  \
                          ##__VA_ARGS__);                                                                              \
    }
#endif
...
#define DEFINE_TRACELOGGING_EVENT_PARAM1(EventId, VarType1, varName1, ...)                                             \
    ...
    {                                                                                                                  \
        TraceLoggingWrite(                                                                                             \
            TraceLoggingType::Provider(), #EventId,                                                                    \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
            _GENERIC_PARTB_FIELDS_ENABLED, ##__VA_ARGS__);                                                             \
    }
#else
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, ...)                                                      \
    template <typename T1, typename T2, typename T3, typename T4>                                                      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, ...)                                                   \
    template <typename T1, typename T2, typename T3, typename T4>                                                      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, ...)                                  \
    template <typename T1, typename T2, typename T3, typename T4, typename T5>                                         \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, ...)                               \
    template <typename T1, typename T2, typename T3, typename T4, typename T5>                                         \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5,                     \
                        PCSTR correlationVector)                                                                       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, ...)              \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>                            \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, ...)           \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>                            \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
                        PCSTR correlationVector)                                                                       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,         \
                                         varName7, ...)                                                                \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>               \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, ...)                                                             \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>               \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,         \
                                         varName7, VarType8, varName8, ...)                                            \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>  \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, VarType8, varName8, ...)                                         \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>  \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,         \
                                         varName7, VarType8, varName8, VarType9, varName9, ...)                        \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,  \
              typename T9>                                                                                             \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM9_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, VarType8, varName8, VarType9, varName9, ...)                     \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,  \
              typename T9>                                                                                             \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
                        T7 &&varName7, T8 &&varName8, T9 &&varName9, PCSTR correlationVector)                          \
    {                                                                                                                  \
        TraceLoggingWrite(                                                                                             \
            TraceLoggingType::Provider(), #EventId,                                                                    \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
#ifdef _GENERIC_PARTB_FIELDS_ENABLED
#define DEFINE_TRACELOGGING_EVENT_PARAM10(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,        \
                                          varName7, VarType8, varName8, VarType9, varName9, VarType10, varName10, ...) \
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,  \
              typename T9, typename T10>                                                                               \
    static void EventId(T1 &&varName1, T2 &&varName2, T3 &&varName3, T4 &&varName4, T5 &&varName5, T6 &&varName6,      \
                        T7 &&varName7, T8 &&varName8, T9 &&varName9, T10 &&varName10)                                  \
    {                                                                                                                  \
        TraceLoggingWrite(                                                                                             \
            TraceLoggingType::Provider(), #EventId,                                                                    \
            TraceLoggingValue(static_cast<VarType1>(wistd::forward<T1>(varName1)), _wiltlg_STRINGIZE(varName1)),       \
...
// attribute of the class with the GUID of your provider, and then include the
// IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY macro within your class.
//
// If you want to register a provider using a callback to log events, you can instead use the
// IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY_AND_CALLBACK Additionally your tracelogging class will have to
// implement a static Callback method. See the declaration within __IMPLEMENT_TRACELOGGING_CLASS_WITH_GROUP_CB.
//
...
#define IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY(TraceLoggingClassName, ProviderName, ProviderId)         \
    IMPLEMENT_TRACELOGGING_CLASS_WITH_GROUP(TraceLoggingClassName, ProviderName, ProviderId,                           \
                                            TraceLoggingOptionMicrosoftTelemetry())
#define IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY_AND_CALLBACK(TraceLoggingClassName, ProviderName,        \
                                                                           ProviderId)                                 \
    IMPLEMENT_TRACELOGGING_CLASS_WITH_GROUP_CB(TraceLoggingClassName, ProviderName, ProviderId,                        \
                                               TraceLoggingOptionMicrosoftTelemetry())
...
#define TraceLoggingProviderWriteTelemetry(TraceLoggingClassName, EventId, ...)                                        \
    TraceLoggingWrite(TraceLoggingClassName::TraceLoggingType::Provider(), EventId,                                    \
                      TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), ##__VA_ARGS__)

#define TraceLoggingProviderWriteMeasure(TraceLoggingClassName, EventId, ...)                                          \
    TraceLoggingWrite(TraceLoggingClassName::TraceLoggingType::Provider(), EventId,                                    \
                      TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), ##__VA_ARGS__)

#define TraceLoggingProviderWriteCriticalData(TraceLoggingClassName, EventId, ...)                                     \
    TraceLoggingWrite(TraceLoggingClassName::TraceLoggingType::Provider(), EventId,                                    \
                      TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), ##__VA_ARGS__)

// [Optional] Custom Events
// Use these macros to define a Custom Event for a Provider.  Use the TraceLoggingClassWrite or
// TraceLoggingClassWriteTelemetry from within a custom event to issue the event.  Methods will be a no-op (and not be
// called) if the provider is not enabled.
...
#define TraceLoggingClassWriteTelemetry(EventId, ...)                                                                  \
    TraceLoggingWrite(TraceLoggingType::Provider(), EventId, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),         \
                      ##__VA_ARGS__)

#define TraceLoggingClassWriteMeasure(EventId, ...)                                                                    \
    TraceLoggingWrite(TraceLoggingType::Provider(), EventId, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),          \
                      ##__VA_ARGS__)
...
#define DEFINE_EVENT_METHOD(MethodName)                                                                                \
    template <typename... TArgs> static void MethodName(TArgs &&...args) WI_NOEXCEPT                                   \
    {                                                                                                                  \
        if (IsEnabled())                                                                                               \
        {                                                                                                              \
...
#define DEFINE_TELEMETRY_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)             \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,   \
                                      varName4)                                                                        \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,   \
                                      varName4, VarType5, varName5)                                                    \
    DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,   \
                                      varName4, VarType5, varName5, VarType6, varName6)                                \
    DEFINE_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6,                                 \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,   \
                                      varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7)            \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,   \
                                      varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,  \
                                      varName8)                                                                        \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
...
#define DEFINE_TELEMETRY_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)          \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4)                                                           \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5)                                       \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5,                                                  \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6)                   \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,         \
                                         varName7)                                                                     \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TELEMETRY_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,          \
                                         VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,         \
                                         varName7, VarType8, varName8)                                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
...
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)           \
    DEFINE_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                                  \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                                 \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3)                                                              \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                                 \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3, VarType4, varName4)                                          \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                       \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3, VarType4, varName4, VarType5, varName5)                      \
    DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),   \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6)  \
    DEFINE_TRACELOGGING_EVENT_PARAM6(                                                                                  \
        ...
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6,  \
                                                VarType7, varName7)                                                    \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                                 \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM8(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, \
                                                varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6,  \
                                                VarType7, varName7, VarType8, varName8)                                \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                       \
                                     TelemetryPrivacyDataTag(PrivacyTag))
...
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM2_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)        \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM3_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3)                                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM4_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3, VarType4, varName4)                             \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                    \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM5_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3, VarType4, varName4, VarType5, varName5)         \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(                                                                               \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM6_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3, VarType4, varName4, VarType5, varName5,         \
                                                   VarType6, varName6)                                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(                                                                               \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM7_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3, VarType4, varName4, VarType5, varName5,         \
                                                   VarType6, varName6, VarType7, varName7)                             \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_TELEMETRY_EVENT_PARAM8_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,        \
                                                   VarType3, varName3, VarType4, varName4, VarType5, varName5,         \
                                                   VarType6, varName6, VarType7, varName7, VarType8, varName8)         \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),          \
                                        TelemetryPrivacyDataTag(PrivacyTag))
...
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM1_CV(EventId, PrivacyTag, EventTag, VarType1, varName1)      \
    DEFINE_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM2_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,      \
                                                               VarType2, varName2)                                     \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM3_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,      \
                                                               VarType2, varName2, VarType3, varName3)                 \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM4_CV(                                                        \
    ...
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                    \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM5_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,      \
                                                               VarType2, varName2, VarType3, varName3, VarType4,       \
                                                               varName4, VarType5, varName5)                           \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5,                                                  \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM6_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,      \
                                                               VarType2, varName2, VarType3, varName3, VarType4,       \
                                                               varName4, VarType5, varName5, VarType6, varName6)       \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
...
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM7_CV(                                                        \
    EventId, PrivacyTag, EventTag, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4,     \
    VarType5, varName5, VarType6, varName6, VarType7, varName7)                                                        \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                              \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_TELEMETRY_EVENT_PARAM8_CV(                                                        \
    EventId, PrivacyTag, EventTag, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4,     \
    VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8)                                    \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),          \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
...
#define DEFINE_MEASURES_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)              \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4)                                                                         \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5)                                                     \
    DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6)                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6,                                 \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7)             \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8)                                                                         \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
...
#define DEFINE_MEASURES_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)           \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4)                                                                      \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5)                                                  \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6)                              \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7)          \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_MEASURES_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8)                                                            \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
...
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)            \
    DEFINE_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                                  \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                                  \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3)                                                               \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                                  \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4)                                           \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                        \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4, VarType5, varName5)                       \
    DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),    \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6)   \
    DEFINE_TRACELOGGING_EVENT_PARAM6(                                                                                  \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6,   \
                                               VarType7, varName7)                                                     \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                                  \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM8(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6,   \
                                               VarType7, varName7, VarType8, varName8)                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                        \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM9(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3,  \
                                               varName3, VarType4, varName4, VarType5, varName5, VarType6, varName6,   \
                                               VarType7, varName7, VarType8, varName8, VarType9, varName9)             \
    DEFINE_TRACELOGGING_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, VarType9, varName9, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),    \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM10(                                                                       \
    EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5,     \
    varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8, VarType9, varName9, VarType10, varName10)    \
    DEFINE_TRACELOGGING_EVENT_PARAM10(                                                                                 \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, VarType7, varName7, VarType8, varName8, VarType9, varName9, VarType10, varName10,          \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), TelemetryPrivacyDataTag(PrivacyTag))
...
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM2_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)         \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM3_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3)                                                  \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM4_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3, VarType4, varName4)                              \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                     \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM5_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3, VarType4, varName4, VarType5, varName5)          \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM6_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3, VarType4, varName4, VarType5, varName5,          \
                                                  VarType6, varName6)                                                  \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(                                                                               \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM7_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3, VarType4, varName4, VarType5, varName5,          \
                                                  VarType6, varName6, VarType7, varName7)                              \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_MEASURES_EVENT_PARAM8_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,         \
                                                  VarType3, varName3, VarType4, varName4, VarType5, varName5,          \
                                                  VarType6, varName6, VarType7, varName7, VarType8, varName8)          \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
...
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM1_CV(EventId, PrivacyTag, EventTag, VarType1, varName1)       \
    DEFINE_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),  \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM2_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,       \
                                                              VarType2, varName2)                                      \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM3_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,       \
                                                              VarType2, varName2, VarType3, varName3)                  \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM4_CV(                                                         \
    ...
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                     \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM5_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,       \
                                                              VarType2, varName2, VarType3, varName3, VarType4,        \
                                                              varName4, VarType5, varName5)                            \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM6_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,       \
                                                              VarType2, varName2, VarType3, varName3, VarType4,        \
                                                              varName4, VarType5, varName5, VarType6, varName6)        \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
...
#define DEFINE_COMPLIANT_EVENTTAGGED_MEASURES_EVENT_PARAM9_CV(                                                         \
    EventId, PrivacyTag, EventTag, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4,     \
    VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8, VarType9, varName9)                \
    DEFINE_TRACELOGGING_EVENT_PARAM9_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, VarType9, varName9,                                        \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                               \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
...
#define DEFINE_CRITICAL_DATA_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)         \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4)                                                          \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4, VarType5, varName5)                                      \
    DEFINE_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5,                                                     \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4, VarType5, varName5, VarType6, varName6)                  \
    DEFINE_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6,                                 \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,        \
                                          varName7)                                                                    \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,         \
                                          VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,        \
                                          varName7, VarType8, varName8)                                                \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
                                     varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
...
#define DEFINE_CRITICAL_DATA_EVENT_PARAM1_CV(EventId, VarType1, varName1)                                              \
    DEFINE_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1,                                                   \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
...
#define DEFINE_CRITICAL_DATA_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)      \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4)                                                       \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5)                                   \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5,                                                  \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6)               \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,     \
                                             varName7)                                                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_CRITICAL_DATA_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,     \
                                             varName7, VarType8, varName8)                                             \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
...
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM1(EventId, PrivacyTag, VarType1, varName1)                           \
    DEFINE_TRACELOGGING_EVENT_PARAM1(EventId, VarType1, varName1,                                                      \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                             \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)       \
    DEFINE_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                                  \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                             \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3)                                                \
    DEFINE_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,              \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                             \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3, VarType4, varName4)                            \
    DEFINE_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                   \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3, VarType4, varName4, VarType5, varName5)        \
    DEFINE_TRACELOGGING_EVENT_PARAM5(                                                                                  \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3, VarType4, varName4, VarType5, varName5,        \
                                                    VarType6, varName6)                                                \
    DEFINE_TRACELOGGING_EVENT_PARAM6(                                                                                  \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3, VarType4, varName4, VarType5, varName5,        \
                                                    VarType6, varName6, VarType7, varName7)                            \
    DEFINE_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,             \
                                     TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                             \
                                     TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM8(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,       \
                                                    VarType3, varName3, VarType4, varName4, VarType5, varName5,        \
                                                    VarType6, varName6, VarType7, varName7, VarType8, varName8)        \
    DEFINE_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4,    \
                                     varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7, VarType8,   \
...
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM2_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)    \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM3_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3)                                             \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM4_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4)                         \
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM5_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5)     \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(                                                                               \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM6_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6)                                             \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(                                                                               \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM7_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6, VarType7, varName7)                         \
    DEFINE_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_COMPLIANT_CRITICAL_DATA_EVENT_PARAM8_CV(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6, VarType7, varName7, VarType8, varName8)     \
    DEFINE_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6, VarType7, varName7,          \
...
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM1_CV(EventId, PrivacyTag, EventTag, VarType1, varName1)  \
    DEFINE_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1,                                                   \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM2_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,  \
                                                                   VarType2, varName2)                                 \
    DEFINE_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                               \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM3_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,  \
                                                                   VarType2, varName2, VarType3, varName3)             \
    DEFINE_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,           \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM4_CV(                                                    \
    ...
    DEFINE_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM5_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,  \
                                                                   VarType2, varName2, VarType3, varName3, VarType4,   \
                                                                   varName4, VarType5, varName5)                       \
    DEFINE_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5,                                                  \
                                        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                          \
                                        TelemetryPrivacyDataTag(PrivacyTag), TraceLoggingEventTag(EventTag))
#define DEFINE_COMPLIANT_EVENTTAGGED_CRITICAL_DATA_EVENT_PARAM6_CV(EventId, PrivacyTag, EventTag, VarType1, varName1,  \
                                                                   VarType2, varName2, VarType3, varName3, VarType4,   \
                                                                   varName4, VarType5, varName5, VarType6, varName6)   \
    DEFINE_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, \
                                        varName4, VarType5, varName5, VarType6, varName6,                              \
...
#define BEGIN_COMPLIANT_TRACELOGGING_ACTIVITY_CLASS(ActivityClassName, PrivacyTag)                                     \
    __BEGIN_TRACELOGGING_ACTIVITY_CLASS(ActivityClassName, wil::ActivityOptions::None, 0, WINEVENT_LEVEL_VERBOSE,      \
                                        PrivacyTag)                                                                    \
    __IMPLEMENT_ACTIVITY_CLASS(ActivityClassName)
...
#define BEGIN_COMPLIANT_CALLCONTEXT_ACTIVITY_CLASS(ActivityClassName, PrivacyTag)                                      \
    __BEGIN_TRACELOGGING_ACTIVITY_CLASS(ActivityClassName, wil::ActivityOptions::TelemetryOnFailure, 0,                \
                                        WINEVENT_LEVEL_VERBOSE, PrivacyTag)                                            \
    __IMPLEMENT_ACTIVITY_CLASS(ActivityClassName)
...
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM1(EventId, VarType1, varName1)                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1(EventId, VarType1, varName1,                                               \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
...
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)      \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4)                                                       \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5)                                   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5,                                    \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6)               \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6,                \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,     \
                                             varName7)                                                                 \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,      \
                                             VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,     \
                                             varName7, VarType8, varName8)                                             \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, VarType7, varName7, VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
...
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM1_CV(EventId, VarType1, varName1)                                           \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1_CV(EventId, VarType1, varName1,                                            \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
...
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4)                                                    \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5)                                \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5,                                 \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6)            \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6,             \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,  \
                                                varName7)                                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY))
#define DEFINE_TAGGED_TELEMETRY_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,   \
                                                VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,  \
                                                varName7, VarType8, varName8)                                          \
...
#define DEFINE_TAGGED_TELEMETRY_EVENT_UINT32(EventId, varName)                                                         \
    DEFINE_TAGGED_TELEMETRY_EVENT_PARAM1(EventId, UINT32, varName)
#define DEFINE_TAGGED_TELEMETRY_EVENT_BOOL(EventId, varName)                                                           \
    DEFINE_TAGGED_TELEMETRY_EVENT_PARAM1(EventId, bool, varName)
#define DEFINE_TAGGED_TELEMETRY_EVENT_STRING(EventId, varName)                                                         \
    DEFINE_TAGGED_TELEMETRY_EVENT_PARAM1(EventId, PCWSTR, varName)
...
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)    \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                           \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                          \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3)                                             \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                          \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4)                         \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),      \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5)     \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6)                                             \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6, VarType7, varName7)                         \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_TELEMETRY),                \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_TELEMETRY_EVENT_PARAM8(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,    \
                                                       VarType3, varName3, VarType4, varName4, VarType5, varName5,     \
                                                       VarType6, varName6, VarType7, varName7, VarType8, varName8)     \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
...
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)       \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4)                                                        \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5)                                    \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5,                                    \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6)                \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6,                \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7)                                                                  \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, VarType8, varName8)                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, VarType7, varName7, VarType8, varName8, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
...
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)    \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4)                                                     \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5)                                 \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5,                                 \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6)             \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6,             \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7)                                                               \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES))
#define DEFINE_TAGGED_MEASURES_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7, VarType8, varName8)                                           \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8_CV(                                                                        \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
...
#define DEFINE_TAGGED_MEASURES_EVENT_UINT32(EventId, varName)                                                          \
    DEFINE_TAGGED_MEASURES_EVENT_PARAM1(EventId, UINT32, varName)
#define DEFINE_TAGGED_MEASURES_EVENT_BOOL(EventId, varName) DEFINE_TAGGED_MEASURES_EVENT_PARAM1(EventId, bool, varName)
#define DEFINE_TAGGED_MEASURES_EVENT_STRING(EventId, varName)                                                          \
    DEFINE_TAGGED_MEASURES_EVENT_PARAM1(EventId, PCWSTR, varName)
...
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2)     \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                           \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                           \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3)                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                           \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3, VarType4, varName4)                          \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),       \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3, VarType4, varName4, VarType5, varName5)      \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3, VarType4, varName4, VarType5, varName5,      \
                                                      VarType6, varName6)                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3, VarType4, varName4, VarType5, varName5,      \
                                                      VarType6, varName6, VarType7, varName7)                          \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_MEASURES),                 \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_MEASURES_EVENT_PARAM8(EventId, PrivacyTag, VarType1, varName1, VarType2, varName2,     \
                                                      VarType3, varName3, VarType4, varName4, VarType5, varName5,      \
                                                      VarType6, varName6, VarType7, varName7, VarType8, varName8)      \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
...
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3)  \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4)                                                   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4, VarType5, varName5)                               \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5,                                    \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4, VarType5, varName5, VarType6, varName6)           \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6,                \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7, \
                                                 varName7)                                                             \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7, \
                                                 varName7, VarType8, varName8)                                         \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, VarType8, varName8,                                              \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,  \
                                                 VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7, \
                                                 varName7, VarType8, varName8, VarType9, varName9)                     \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM9(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, VarType8, varName8, VarType9, varName9,                          \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
...
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2)                   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM2_CV(EventId, VarType1, varName1, VarType2, varName2,                        \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3)                                                          \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3, VarType4, varName4)                                      \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4,                                                     \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3, VarType4, varName4, VarType5, varName5)                  \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5,                                 \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3, VarType4, varName4, VarType5, varName5, VarType6,        \
                                                    varName6)                                                          \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6,             \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3, VarType4, varName4, VarType5, varName5, VarType6,        \
                                                    varName6, VarType7, varName7)                                      \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3,         \
                                                    varName3, VarType4, varName4, VarType5, varName5, VarType6,        \
                                                    varName6, VarType7, varName7, VarType8, varName8)                  \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8_CV(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,    \
                                               VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,   \
                                               varName7, VarType8, varName8,                                           \
                                               TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA))
...
#define DEFINE_TAGGED_CRITICAL_DATA_EVENT_BOOL(EventId, varName)                                                       \
    DEFINE_TAGGED_CRITICAL_DATA_EVENT_PARAM1(EventId, bool, varName)
...
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM1(EventId, PrivacyTag, VarType1, varName1)                    \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM1(EventId, VarType1, varName1,                                               \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                      \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM2(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2)                                                   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM2(EventId, VarType1, varName1, VarType2, varName2,                           \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                      \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM3(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2, VarType3, varName3)                               \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM3(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),                      \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM4(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2, VarType3, varName3, VarType4, varName4)           \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM4(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),  \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM5(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2, VarType3, varName3, VarType4, varName4, VarType5, \
                                                           varName5)                                                   \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM5(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM6(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2, VarType3, varName3, VarType4, varName4, VarType5, \
                                                           varName5, VarType6, varName6)                               \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM6(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM7(EventId, PrivacyTag, VarType1, varName1, VarType2,          \
                                                           varName2, VarType3, varName3, VarType4, varName4, VarType5, \
                                                           varName5, VarType6, varName6, VarType7, varName7)           \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM7(EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3,       \
                                            VarType4, varName4, VarType5, varName5, VarType6, varName6, VarType7,      \
                                            varName7, TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA),            \
                                            TelemetryPrivacyDataTag(PrivacyTag))
#define DEFINE_TAGGED_COMPLIANT_CRITICAL_DATA_EVENT_PARAM8(                                                            \
    EventId, PrivacyTag, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5,     \
    varName5, VarType6, varName6, VarType7, varName7, VarType8, varName8)                                              \
    DEFINE_TAGGED_TRACELOGGING_EVENT_PARAM8(                                                                           \
        EventId, VarType1, varName1, VarType2, varName2, VarType3, varName3, VarType4, varName4, VarType5, varName5,   \
        VarType6, varName6, VarType7, varName7, VarType8, varName8,                                                    \
        TraceLoggingKeyword(MICROSOFT_KEYWORD_CRITICAL_DATA), TelemetryPrivacyDataTag(PrivacyTag))
...
// These are desktop only and are not recommended by the fundamentals team.  These activities lag behind regular
// activities in their ability to use CallContext or to be cross-thread portable, so their usage should be limited.
    ...
    {                                                                                                                  \
      ...
      public:                                                                                                          \
        ...
        {                                                                                                              \
                                                                                                                       ...
                                                                                                                       \
      private:                                                                                                         \
        template <typename... TArgs> ActivityClassName(_In_ void **, TArgs &&...args) : m_result(S_OK)                 \
        {                                                                                                              \
            StartActivity(wistd::forward<TArgs>(args)...);                                                             \
        }                                                                                                              \
                                                                                                                       \
      ...
      public:                                                                                                          \
        ...
        template <typename... TArgs> static ActivityClassName Start(TArgs &&...args)                                   \
        {                                                                                                              \
...
#define BEGIN_DEFINE_TRACELOGGING_THREAD_ACTIVITY_CLASS_WITH_KEYWORD(ActivityClassName, keyword)                       \
    BEGIN_DEFINE_TRACELOGGING_THREAD_ACTIVITY_CLASS_WITH_KEYWORD_LEVEL(ActivityClassName, keyword,                     \
...
template <typename T> class ActivityErrorTracer
{
  public:
...
#pragma detect_mismatch("ODR_violation_WIL_API_TELEMETRY_SUSPEND_HANDLER_mismatch", "0")
        ...
        class ApiTelemetryLogger : public wil::TraceLoggingProvider
        {
            ...
            IMPLEMENT_TRACELOGGING_CLASS_WITH_MICROSOFT_TELEMETRY(ApiTelemetryLogger, "Microsoft.Windows.ApiTelemetry",
                                                                  (0xfb7fcbc6, 0x7156, 0x5a5b, 0xea, 0xbd, 0x0b, 0xe4,
                                                                   0x7b, 0x14, 0xf4, 0x53));
            ...
            class ApiDataList
            {
              public:
                struct ApiData
                {
                    ...
                    ApiData(PCWSTR className_, PCWSTR apiName_, PCSTR specialization_, volatile long *counterReference_)
                        : className(className_), apiName(apiName_), specialization(specialization_),
                          counterReference(counterReference_)
                    {
                    }
                };

                // Inserts a new Api call counter into the list, keeping the list sorted by className
                void Insert(PCWSTR className, PCWSTR apiName, _In_opt_ PCSTR specialization,
                            volatile long *counterReference)
                {
                    wistd::unique_ptr<ApiData> newApiData(
                        new (std::nothrow) ApiData(className, apiName, specialization, counterReference));
                    if (newApiData)
                    {
                ...
                // After returning, it will have deleted all ApiData elements, and zeroed the *counterReference stored
                // in each ApiData.
                void Flush(wistd::function<void(PCWSTR, PCWSTR, PCSTR, UINT32 *, UINT16)> flushCallback)
                {
                    ...
                    while (root)
                    {
                        // First find the number of characters we need to allocate for each string, and the number of
                        // items in the counter array to allocate
                        ...
                        ProcessSingleNamespace(&root, [&](wistd::unique_ptr<ApiData> &node) {
                            ...
                            totalApiListLength += (classStrLen + wcslen(node->apiName) +
                                                   1); // We add 1 to account for the comma delimiter
                            if (node->specialization)
                            {
                                totalSpecializationsLength +=
                                    strlen(node->specialization) + 1; // We add 1 to account for the comma delimiter
                            }
                            else
                            {
                        ...
                        wistd::unique_ptr<char[]> specializationList(
                            new (std::nothrow) char[totalSpecializationsLength]);
                        ...
                        wistd::unique_ptr<ApiData> *lastNamespaceNode =
                            ProcessSingleNamespace(&root, [&](wistd::unique_ptr<ApiData> &node) {
                                countArray[countArrayIndex] =
                                    static_cast<UINT32>(::InterlockedExchangeNoFence(node->counterReference, 0));

                                // Prepend the portion of the apiName group string that's after the '.'. So for example,
                                // if the className is "Windows.System.Launcher", then we prepend "Launcher." to the
                                // apiName string.
                                const wchar_t *strAfterNamespace = GetClassStringPointer(node->className);
                                if (strAfterNamespace)
                                {
                                    FAIL_FAST_IF_FAILED(
                                        StringCchCatW(apiList.get(), totalApiListLength, strAfterNamespace + 1));
                                ...
                                if (node->specialization)
                                {
                                    FAIL_FAST_IF(strncat_s(specializationList.get(), totalSpecializationsLength,
                                                           node->specialization, strlen(node->specialization)) != 0);
                                }
                                else
                                {
                                    FAIL_FAST_IF(
                                        strncat_s(specializationList.get(), totalSpecializationsLength, "-", 1) != 0);
                                }
                        ...
                        flushCallback(nameSpace.get(), apiList.get(), specializationList.get(), countArray.get(),
                                      numCounts);
              ...
              private:
                static wistd::unique_ptr<ApiData> *ProcessSingleNamespace(
                    wistd::unique_ptr<ApiData> *root,
                    wistd::function<void(wistd::unique_ptr<ApiData> &)> workerCallback)
                {
                ...
                {
                    // Note: Usage of wcsrchr can cause build errors in some components, so we implement a way of
                    // getting the pointer to the 'class' portion of the string ourselves.
                    int retIndex = 0;
          ...
          public:
            ...
            //
            // This function only needs to be called once for each API, although it doesn't hurt if it gets called more
            // than once.
            //
            // The apiName, className, and specialization parameters should be compile time constants. specialization
            // can be null.
            ...
            {
                // TODO: Validate that apiName and className are a compile-time constants; validate that specialization
                // is either compile-time constant or nullptr; validate that counterReference points to static variable.
            ...
            {
                m_apiDataList.Flush([](PCWSTR nameSpace, PCWSTR apiList, PCSTR specializationList, UINT32 *countArray,
                                       UINT16 numCounters) {
                    if (::wil::details::IsDebuggerPresent())
                    {
                        TraceLoggingWrite(Provider(), "ApiCallCountsWithDebuggerPresent",
                    ...
                    {
                        TraceLoggingWrite(Provider(), "ApiCallCounts", TraceLoggingValue(nameSpace, "Namespace"),
                                          TraceLoggingValue(apiList, "ApiDataList"),
                                          TraceLoggingValue(specializationList, "CustomList"),
                                          TraceLoggingUInt32Array(countArray, numCounters, "HitCounts"),
                                          TraceLoggingBoolean(TRUE, "UTCReplace_AppSessionGuid"),
                    ...
                    __TRACELOGGING_TEST_HOOK_VERIFY_API_TELEMETRY(nameSpace, apiList, specializationList, countArray,
                                                                  numCounters);
                });
          ...
          private:
            ...
            ~ApiTelemetryLogger() WI_NOEXCEPT override
            {
                ...
                // release handle to thread pool timer instead of its destructor being call, if process is being
                // terminated and dll is not being unloaded dynamically destruction of threadpool timer is considered
                // invalid during process termination
            ...
            {
                // do not schedule thread pool timer callback, if process is being terminated and dll is not being
...
// and pass the fully qualified class name (in the case of WinRT), or a string identifying the group of the non-WinRT
// API:
//  - WI_LOG_CLASS_API_USE(RuntimeClass_Windows_System_Launcher, L"LaunchUriAsync");
//
// Note: If the component can have a suspend handler, the following line should be added before including
// TraceLogging.h:
...
// exception being thrown if process is getting terminated and dll in which ApiTelemetryLogger is not getting
// dynamically unloaded. For more details about lpReserved parameter, please refer to MSDN.
...
#define __WI_LOG_CLASS_API_USE3(className, apiName, specialization)                                                    \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ::wil::details::ApiTelemetryLogger::InitApiData(className, apiName, specialization,                        \
                                                            &__wil_apiCallCounter);                                    \
        }                                                                                                              \
    } while (0, 0)
