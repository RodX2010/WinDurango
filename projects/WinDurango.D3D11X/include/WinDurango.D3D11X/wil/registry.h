...
namespace wil
{
    ...
    namespace reg
    {
         ...
         */
        inline ::wil::unique_hkey open_unique_key(HKEY key, _In_opt_ PCWSTR subKey,
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline ::wil::unique_hkey create_unique_key(HKEY key, PCWSTR subKey,
                                                    ::wil::reg::key_access access = ::wil::reg::key_access::read)
        {
            const reg_view_details::reg_view regview{key};
            ::wil::unique_hkey return_value;
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline ::wil::shared_hkey open_shared_key(HKEY key, _In_opt_ PCWSTR subKey,
                                                  ::wil::reg::key_access access = ::wil::reg::key_access::read)
        {
            const reg_view_details::reg_view regview{key};
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline ::wil::shared_hkey create_shared_key(HKEY key, PCWSTR subKey,
                                                    ::wil::reg::key_access access = ::wil::reg::key_access::read)
        {
            const reg_view_details::reg_view regview{key};
            ::wil::shared_hkey return_value;
         ...
         */
        inline HRESULT open_unique_key_nothrow(HKEY key, _In_opt_ PCWSTR subKey, ::wil::unique_hkey &hkey,
                                               ::wil::reg::key_access access = ::wil::reg::key_access::read) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT create_unique_key_nothrow(HKEY key, PCWSTR subKey, ::wil::unique_hkey &hkey,
                                                 ::wil::reg::key_access access = ::wil::reg::key_access::read)
            WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT open_shared_key_nothrow(HKEY key, _In_opt_ PCWSTR subKey, ::wil::shared_hkey &hkey,
                                               ::wil::reg::key_access access = ::wil::reg::key_access::read) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
            return regview.open_key(subKey, hkey.put(), access);
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT create_shared_key_nothrow(HKEY key, PCWSTR subKey, ::wil::shared_hkey &hkey,
                                                 ::wil::reg::key_access access = ::wil::reg::key_access::read)
            WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
        ...
        //     }
        //
        //     for (const auto& value_data : wil::make_range(wil::reg::value_iterator{hkey},
        ...
        //
        //     for (const auto& key_data : wil::make_range(wil::reg::key_heap_string_iterator{hkey},
        //     wil::reg::key_heap_string_iterator{}))
        //     {
        //         key_data.name.get(); // the PCWSTR of the enumerated key
        //     }
        //
        //     for (const auto& value_data : wil::make_range(wil::reg::value_heap_string_iterator{hkey},
        ...
        //     for (const auto& value_data : wil::make_range(iterate_values,
        //     wil::reg::value_heap_string_nothrow_iterator{}))
        //     {
        //         value_data.name.get(); // the PCWSTR of the enumerated value
        //         value_data.type; // the REG_ type of the enumerated value
        //     }
        ...
        using key_heap_string_iterator =
            ::wil::reg::iterator_t<::wil::reg::key_iterator_data<::wil::unique_process_heap_string>>;
        using value_heap_string_iterator =
            ::wil::reg::iterator_t<::wil::reg::value_iterator_data<::wil::unique_process_heap_string>>;

#endif // #if defined(WIL_ENABLE_EXCEPTIONS)

        // no-throw versions of applicable registry iterators
#if defined(__WIL_OLEAUTO_H_) || defined(WIL_DOXYGEN)
        using key_bstr_nothrow_iterator =
            ::wil::reg::iterator_nothrow_t<::wil::reg::key_iterator_data<::wil::unique_bstr>>;
        using value_bstr_nothrow_iterator =
            ::wil::reg::iterator_nothrow_t<::wil::reg::value_iterator_data<::wil::unique_bstr>>;
#endif // #if defined(__WIL_OLEAUTO_H_)
        ...
        {
            RETURN_IF_WIN32_ERROR(RegQueryInfoKeyW(key,
                                                   nullptr, // null class
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        template <typename T> void set_value(HKEY key, _In_opt_ PCWSTR value_name, const T &data)
        {
         ...
         * @param value_name The name of the registry value whose data is to be updated.
         *        Can be nullptr to write to the unnamed default registry value.
         * @param data The null-terminated, unexpanded string value to write to the specified registry value. For
         * example, `%PATH%`.
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline void set_value(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                              const ::std::vector<::std::wstring> &data)
        {
            const auto multiStringWcharVector(
                reg_view_details::get_multistring_from_wstrings(::std::begin(data), ::std::end(data)));
            const reg_view_details::reg_view regview{key};
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline void set_value_multistring(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                          const ::std::vector<::std::wstring> &data)
        {
            ::wil::reg::set_value(key, subkey, value_name, data);
        }
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline void set_value_multistring(HKEY key, _In_opt_ PCWSTR value_name,
                                          const ::std::vector<::std::wstring> &data)
        {
            ::wil::reg::set_value(key, nullptr, value_name, data);
        }
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline void set_value_binary(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name, uint32_t type,
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures
         */
        inline void set_value_binary(HKEY key, _In_opt_ PCWSTR value_name, uint32_t type,
                                     const ::std::vector<uint8_t> &data)
        {
         ...
         */
        template <typename T>
        HRESULT set_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                  const T &data) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        template <typename T> HRESULT set_value_nothrow(HKEY key, _In_opt_ PCWSTR value_name, const T &data) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         PCWSTR data) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
            return regview.set_value(subkey, value_name, data);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_dword_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                               uint32_t data) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_qword_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                               uint64_t data) WI_NOEXCEPT
        {
            return ::wil::reg::set_value_nothrow(key, subkey, value_name, data);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                PCWSTR data) WI_NOEXCEPT
        {
            return ::wil::reg::set_value_nothrow(key, subkey, value_name, data);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                         PCWSTR data) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         * @param value A ::wil::unique_cotaskmem_array_ptr<BYTE> holding the bytes to write into the specified registry
         * value
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_binary_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                uint32_t type,
                                                const ::wil::unique_cotaskmem_array_ptr<uint8_t> &value) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
            RETURN_IF_FAILED(
                regview.set_value<::wil::unique_cotaskmem_array_ptr<uint8_t>>(subkey, value_name, value, type));
            return S_OK;
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT set_value_binary_nothrow(HKEY key, _In_opt_ PCWSTR value_name, uint32_t type,
                                                const ::wil::unique_cotaskmem_array_ptr<uint8_t> &value) WI_NOEXCEPT
        {
        ...
        //     std::wstring expanded_string_value = wil::reg::get_value_expanded_string(key,
        //     L"string_value_name_with_environment_variables");
        //
        ...
        //     std::vector<std::wstring> multi_string_value = wil::reg::get_value_multistring(key,
        //     L"multi_string_value_name"); for (const auto& sub_string_value : multi_string_value)
        //     {
        //         // can read each string parsed from the multi-string
        //         PCWSTR string_value = sub_string_value.c_str();
        //     }
        //
        // Reading REG_SZ and REG_EXPAND_SZ types are done through the below templated get_value_string and
        // get_value_expanded_string functions Where the template type is the type to receive the string value The
        // default template type is std::wstring, available if the caller has included the STL <string> header
        //
        // Reading a bstr can be stored in a wil::shared_bstr or wil::unique_bstr - wil::shared_bstr has a c'tor taking
        // a wil::unique_bstr
        //     wil::unique_bstr unique_value { wil::reg::get_value_string<::wil::unique_bstr>(key, L"string_value_name")
        //     }; wil::shared_bstr shared_value { wil::reg::get_value_string<::wil::shared_bstr>(key,
        //     L"string_value_name") };
        //
        // Reading a cotaskmem string can be stored in a wil::unique_cotaskmem_string or wil::shared_cotaskmem_string
        //     wil::unique_cotaskmem_string unique_value { wil::reg::get_value_string<wil::unique_cotaskmem_string>(key,
        //     L"string_value_name") }; wil::shared_cotaskmem_string shared_value {
        //     wil::reg::get_value_string<wil::shared_cotaskmem_string>(key, L"string_value_name") };
        //
        // Blocking get_value_string template types that are not already specialized - this gives a much friendlier
        ...
        template <typename T> T get_value_string(HKEY /*key*/, _In_opt_ PCWSTR /*value_name*/)
        {
            static_assert(sizeof(T) != sizeof(T), "Unsupported type for get_value_string");
        }
        ...
        template <typename T> T get_value_expanded_string(HKEY /*key*/, _In_opt_ PCWSTR /*value_name*/)
        {
            static_assert(sizeof(T) != sizeof(T), "Unsupported type for get_value_expanded_string");
        }
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on all failures, including value
         * not found
         */
        template <typename T> T get_value(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name)
        {
            T return_value{};
            const reg_view_details::reg_view regview{key};
         ...
         * not found
         */
        template <typename T> T get_value(HKEY key, _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::std::wstring get_value_string<::std::wstring>(HKEY key, _In_opt_ PCWSTR subkey,
         ...
         * not found
         */
        template <> inline ::std::wstring get_value_string<::std::wstring>(HKEY key, _In_opt_ PCWSTR value_name)
        {
            return ::wil::reg::get_value<::std::wstring>(key, nullptr, value_name);
        }
         ...
         */
        template <>
        inline ::std::wstring get_value_expanded_string<::std::wstring>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                        _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::wil::unique_bstr get_value_string<::wil::unique_bstr>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                       _In_opt_ PCWSTR value_name)
        {
         ...
         * not found
         */
        template <> inline ::wil::unique_bstr get_value_string<::wil::unique_bstr>(HKEY key, _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::wil::unique_bstr get_value_expanded_string<::wil::unique_bstr>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                                _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::wil::shared_bstr get_value_string<::wil::shared_bstr>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                       _In_opt_ PCWSTR value_name)
        {
         ...
         * not found
         */
        template <> inline ::wil::shared_bstr get_value_string<::wil::shared_bstr>(HKEY key, _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::wil::shared_bstr get_value_expanded_string<::wil::shared_bstr>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                                _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::wil::unique_cotaskmem_string get_value_string<::wil::unique_cotaskmem_string>(
         ...
         */
        template <>
        inline ::wil::shared_cotaskmem_string get_value_string<::wil::shared_cotaskmem_string>(
            HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name)
        {
         ...
         * not found
         */
        inline ::std::vector<uint8_t> get_value_binary(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                       uint32_t type)
        {
         ...
         * @param value_name The name of the registry value whose data is to be updated.
         *        Can be nullptr to read from the unnamed default registry value.
         * @return A vector of strings read from the REG_MULTI_SZ. Note: embedded nulls will be read as empty strings.
         * See remarks.
         * @exception std::exception (including wil::ResultException) will be thrown on all failures, including value
         * not found
         *
         * @remark Note that will return empty strings for embedded nulls - it won't stop at the first double-null
         * character e.g. a REG_MULTI_SZ of L"string1\0\0string2\0\0string3\0\0" returns a vector of size 5: L"string1",
         * empty-string, L"string2", empty-string, L"string3"
         */
        template <>
         ...
         */
        template <>
        inline ::std::vector<::std::wstring> get_value<::std::vector<::std::wstring>>(HKEY key,
                                                                                      _In_opt_ PCWSTR value_name)
        {
         ...
         * empty-string, L"string2", empty-string, L"string3"
         */
        inline ::std::vector<::std::wstring> get_value_multistring(HKEY key, _In_opt_ PCWSTR subkey,
                                                                   _In_opt_ PCWSTR value_name)
        {
        ...
        //  - throws a std::exception on failure (including wil::ResultException), except if the registry value was not
        //  found
        //    returns a std::nullopt if the registry value is not found
        //
        // Examples using the returned std::optional<uint32_t>
        //  - Caller should ensure the code handles a possible std::exception that will be thrown on all errors except
        //  value not found
        //
        ...
        //     // note that std::optional only attempts to construct a std::wstring for L"default" if the std::optional
        //     is empty (std::nullopt)
        //     // thus only allocating a new std::wstring for the default value when it's needed
        //     std::optional<std::wstring> opt_string_value = wil::reg::try_get_value_string(key,
        //     L"string_value_name").value_or(L"default");
        //
        // Examples of usage:
        //     std::optional<uint32_t> opt_dword_value = wil::reg::try_get_value<uint32_t>(key, L"subkey",
        //     L"dword_value_name"); std::optional<uint64_t> opt_qword_value = wil::reg::try_get_value<uint64_t>(key,
        //     L"subkey", L"qword_value_name); std::optional<std::wstring> opt_string_value =
        //     wil::reg::try_get_value<std::wstring>(key, L"subkey", L"string_value_name");
        //
        ...
        //     std::optional<std::wstring> opt_string_value = wil::reg::try_get_value<std::wstring>(key,
        //     L"string_value_name");
        //
        ...
        //
        // Values with REG_EXPAND_SZ can be read into each of the string types; e.g.:
        //     std::optional<std::wstring> opt_expanded_string_value = wil::reg::try_get_value_expanded_string(key,
        //     L"string_value_name_with_environment_variables");
        //
        // Values can be read directly into a vector of bytes - the registry type must be specified; e.g.:
        //     std::optional<std::vector<BYTE>> opt_data = wil::reg::try_get_value_binary(key, L"binary_value_name",
        //     REG_BINARY);
        //
        ...
        //
        // Reading REG_SZ and REG_EXPAND_SZ types are done through the below templated try_get_value_string and
        // try_get_value_expanded_string functions Where the template type is the type to receive the string value The
        // default template type is std::wstring, available if the caller has included the STL <string> header
        //
        // Reading a bstr is returned in a std::optional<wil::shared_bstr> - because wil::unique_bstr cannot be copied
        // and thus is difficult to work with a std::optional
        //     std::optional<wil::shared_bstr> shared_value { wil::reg::try_get_value_string<::wil::shared_bstr>(key,
        //     L"string_value_name") };
        //
        // Reading a cotaskmem string is returned in a std::optional<wil::shared_cotaskmem_string> - because
        // wil::unique_cotaskmem_string cannot be copied and thus is difficult to work with a std::optional
        //     std::optional<wil::shared_cotaskmem_string> opt_shared_value {
        //     wil::reg::try_get_value_string<wil::shared_cotaskmem_string>(key, L"string_value_name") };
        //
        // Blocking try_get_value_string template types that are not already specialized - this gives a much friendlier
        // compiler error message
        template <typename T>
        ::std::optional<T> try_get_value_string(HKEY /*key*/, _In_opt_ PCWSTR /*subkey*/,
                                                _In_opt_ PCWSTR /*value_name*/)
        {
            static_assert(sizeof(T) != sizeof(T), "Unsupported type for try_get_value_string");
        }

        template <typename T>::std::optional<T> try_get_value_string(HKEY /*key*/, _In_opt_ PCWSTR /*value_name*/)
        {
            static_assert(sizeof(T) != sizeof(T), "Unsupported type for try_get_value_string");
        }

        template <typename T>
        ::std::optional<T> try_get_value_expanded_string(HKEY /*key*/, _In_opt_ PCWSTR /*subkey*/,
                                                         _In_opt_ PCWSTR /*value_name*/)
        {
        ...
        /**
         * @brief Attempts to read a value under a specified key and subkey, returning in a std::optional, deducing
         * registry type from the type parameter T.
         * @tparam T The type to read, which will be placed into a std::optional (the registry value type is deduced
         * from T)
         * @param key An open or well-known registry key
         * @param subkey The name of the subkey to append to `key`.
         *        If `nullptr`, then `key` is used without modification.
        ...
        ::std::optional<T> try_get_value(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name)
        {
            ...
            // not allowing unique types with try_get_value: wil::unique_bstr cannot be copied and thus is difficult to
            // work with a std::optional
            static_assert(!wistd::is_same_v<T, ::wil::unique_bstr>, "try_get with wil::unique_bstr is disabled");
#endif // #if defined(__WIL_OLEAUTO_H_)
#if defined(__WIL_OBJBASE_H_)
            // not allowing unique types with try_get_value: wil::unique_cotaskmem_string cannot be copied and thus is
            // difficult to work with a std::optional
            static_assert(!wistd::is_same_v<T, ::wil::unique_cotaskmem_string>,
                          "try_get with wil::unique_cotaskmem_string is disabled");
        ...
        /**
         * @brief Attempts to read a value under a specified key, returning the value in a std::optional, deducing
         * registry type from the type parameter T.
         * @tparam T The type to read, which will be placed into a std::optional (the registry value type is deduced
         * from T)
         * @param key An open or well-known registry key
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        template <typename T>::std::optional<T> try_get_value(HKEY key, _In_opt_ PCWSTR value_name)
        {
#if defined(__WIL_OLEAUTO_H_)
            // not allowing unique types with try_get_value: wil::unique_bstr cannot be copied and thus is difficult to
            // work with a std::optional
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<uint32_t> try_get_value_dword(HKEY key, _In_opt_ PCWSTR subkey,
                                                             _In_opt_ PCWSTR value_name)
        {
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<uint64_t> try_get_value_qword(HKEY key, _In_opt_ PCWSTR subkey,
                                                             _In_opt_ PCWSTR value_name)
        {
...
#if WIL_USE_STL || defined(WIL_DOXYGEN)
        /**
         * @brief Attempts to read a value under a specified key requiring the specified type, returning the raw bytes
         * in a std::optional
         * @param key An open or well-known registry key
         * @param subkey The name of the subkey to append to `key`.
         *        If `nullptr`, then `key` is used without modification.
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<::std::vector<uint8_t>> try_get_value_binary(HKEY key, _In_opt_ PCWSTR subkey,
                                                                            _In_opt_ PCWSTR value_name, uint32_t type)
        {
            const reg_view_details::reg_view regview{key};
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<::std::vector<uint8_t>> try_get_value_binary(HKEY key, _In_opt_ PCWSTR value_name,
                                                                            uint32_t type)
        {
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<::std::wstring> try_get_value_string(HKEY key, _In_opt_ PCWSTR subkey,
                                                                    _In_opt_ PCWSTR value_name)
        {
            const reg_view_details::reg_view regview{key};
         ...
         */
        template <>
        inline ::std::optional<::std::wstring> try_get_value_string<::std::wstring>(HKEY key, _In_opt_ PCWSTR subkey,
                                                                                    _In_opt_ PCWSTR value_name)
        {
         ...
         */
        template <>
        inline ::std::optional<::std::wstring> try_get_value_string<::std::wstring>(HKEY key,
                                                                                    _In_opt_ PCWSTR value_name)
        {
            return ::wil::reg::try_get_value_string(key, nullptr, value_name);
        }
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<::std::wstring> try_get_value_expanded_string(HKEY key, _In_opt_ PCWSTR subkey,
                                                                             _In_opt_ PCWSTR value_name)
        {
            const reg_view_details::reg_view regview{key};
         ...
         */
        template <>
        inline ::std::optional<::std::wstring> try_get_value_expanded_string<::std::wstring>(HKEY key,
         ...
         */
        template <>
        inline ::std::optional<::wil::shared_bstr> try_get_value_string<::wil::shared_bstr>(HKEY key,
                                                                                            _In_opt_ PCWSTR subkey,
                                                                                            _In_opt_ PCWSTR value_name)
        {
            const reg_view_details::reg_view regview{key};
         ...
         * @param value_name The name of the registry value whose data is to be updated.
         *        Can be nullptr to read from the unnamed default registry value.
         * @return The value read from the registry value of the template type
         * std::optional<wil::shared_cotaskmem_string>. Returns std::nullopt if the value does not exist.
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        template <>
         ...
         *        Can be nullptr to read from the unnamed default registry value.
         * @return The value read from the registry value of the template type
         * std::optional<:wil::shared_cotaskmem_string>, with environment variables expanded, as though passed through
         * ExpandEnvironmentStringsW. Returns std::nullopt if the value does not exist.
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        template <>
        inline ::std::optional<::wil::shared_cotaskmem_string> try_get_value_expanded_string<
            ::wil::shared_cotaskmem_string>(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name)
        {
            const reg_view_details::reg_view regview{key};
        ...
        template <>
        inline ::std::optional<::wil::shared_cotaskmem_string> try_get_value_expanded_string<
            ::wil::shared_cotaskmem_string>(HKEY key, _In_opt_ PCWSTR value_name)
        {
            ...
            HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name)
        {
            ...
            const auto hr =
                ::wil::ResultFromException([&] { value = ::wil::reg::get_value_multistring(key, subkey, value_name); });
            if (SUCCEEDED(hr))
            {
                return value;
            }
         ...
         * @exception std::exception (including wil::ResultException) will be thrown on failures except value not found
         */
        inline ::std::optional<::std::vector<::std::wstring>> try_get_value_multistring(HKEY key,
                                                                                        _In_opt_ PCWSTR subkey,
                                                                                        _In_opt_ PCWSTR value_name)
        {
        ...
        //
        // Example storing directly into a WCHAR array - note will return the required number of bytes if the supplied
        // array is too small
        ...
        //
        // Reading REG_SZ and REG_EXPAND_SZ types are done through the below templated get_value_string_nothrow and
        // get_value_expanded_string_nothrow functions Where the template type is the type to receive the string value
        // The default template type is std::wstring, available if the caller has included the STL <string> header
        //
        // Example storing a string in a wil::unique_bstr, wil::shared_bstr, wil::unique_cotaskmem_string, or
        ...
        HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                  _Out_ T *return_value) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         *             Will write to the WCHAR array the string value read from the registry, guaranteeing
         * null-termination
         * @param[out] requiredBytes An optional pointer to a unsigned 32-bit value to receive the required bytes of the
         * string in the registry
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        template <size_t Length, typename DwordType,
                  wistd::enable_if_t<wistd::is_same_v<DwordType, uint32_t> ||
                                     wistd::is_same_v<DwordType, unsigned long>> * = nullptr>
        HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         WCHAR (&return_value)[Length], _Out_opt_ DwordType *requiredBytes) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         *             Will write to the WCHAR array the string value read from the registry, guaranteeing
         * null-termination
         * @param[out] requiredBytes An optional pointer to an unsigned 32-bit value to receive the required bytes of
        ...
        template <size_t Length, typename DwordType,
                  wistd::enable_if_t<wistd::is_same_v<DwordType, uint32_t> ||
                                     wistd::is_same_v<DwordType, unsigned long>> * = nullptr>
        HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name, WCHAR (&return_value)[Length],
                                         _Out_opt_ DwordType *requiredBytes) WI_NOEXCEPT
        {
        ...
        HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         WCHAR (&return_value)[Length]) WI_NOEXCEPT
        {
         ...
         */
        template <size_t Length>
        HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name,
                                         WCHAR (&return_value)[Length]) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        template <typename DwordType, wistd::enable_if_t<wistd::is_same_v<DwordType, uint32_t> ||
                                                         wistd::is_same_v<DwordType, unsigned long>> * = nullptr>
        HRESULT get_value_dword_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                        _Out_ DwordType *return_value) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        template <typename QwordType, wistd::enable_if_t<wistd::is_same_v<QwordType, uint64_t> ||
                                                         wistd::is_same_v<QwordType, unsigned long long>> * = nullptr>
        HRESULT get_value_qword_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                        _Out_ QwordType *return_value) WI_NOEXCEPT
        {
            return ::wil::reg::get_value_nothrow(key, subkey, value_name, return_value);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR value_name,
                                         ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
            return ::wil::reg::get_value_nothrow(key, nullptr, value_name, return_value);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name,
                                                ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
         ...
         */
        inline HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         ::wil::shared_bstr &return_value) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
            return regview.get_value(subkey, value_name, return_value);
        }
         ...
         */
        inline HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         ::wil::unique_cotaskmem_string &return_value) WI_NOEXCEPT
        {
            return_value.reset();
            const reg_view_details::reg_view_nothrow regview{key};
            return regview.get_value(subkey, value_name, return_value);
         ...
         */
        inline HRESULT get_value_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                         ::wil::shared_cotaskmem_string &return_value) WI_NOEXCEPT
        {
            return_value.reset();
            const reg_view_details::reg_view_nothrow regview{key};
            return regview.get_value(subkey, value_name, return_value);
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_binary_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                uint32_t type,
                                                ::wil::unique_cotaskmem_array_ptr<uint8_t> &return_value) WI_NOEXCEPT
        {
            ...
            const reg_view_details::reg_view_nothrow regview{key};
            RETURN_IF_FAILED(
                regview.get_value<::wil::unique_cotaskmem_array_ptr<uint8_t>>(subkey, value_name, return_value, type));
            return S_OK;
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_binary_nothrow(HKEY key, _In_opt_ PCWSTR value_name, uint32_t type,
                                                ::wil::unique_cotaskmem_array_ptr<uint8_t> &return_value) WI_NOEXCEPT
        {
         ...
         *             Will write to the WCHAR array the string value read from the registry, guaranteeing
         * null-termination
         * @param[out] requiredBytes An optional pointer to a uint32_t to receive the required bytes of the string to be
         * read
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        template <size_t Length, typename DwordType,
                  wistd::enable_if_t<wistd::is_same_v<DwordType, uint32_t> ||
                                     wistd::is_same_v<DwordType, unsigned long>> * = nullptr>
        HRESULT get_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                  WCHAR (&return_value)[Length],
                                                  _Out_opt_ DwordType *requiredBytes) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
        ...
        template <size_t Length, typename DwordType,
                  wistd::enable_if_t<wistd::is_same_v<DwordType, uint32_t> ||
                                     wistd::is_same_v<DwordType, unsigned long>> * = nullptr>
        HRESULT get_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name, WCHAR (&return_value)[Length],
                                                  _Out_opt_ DwordType *requiredBytes) WI_NOEXCEPT
        {
         ...
         */
        template <size_t Length>
        HRESULT get_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name,
                                                  WCHAR (&return_value)[Length]) WI_NOEXCEPT
        {
            return ::wil::reg::get_value_expanded_string_nothrow<Length>(key, nullptr, value_name, return_value);
        }
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR subkey, _In_opt_ PCWSTR value_name,
                                                         ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
            const reg_view_details::reg_view_nothrow regview{key};
         ...
         * @return HRESULT error code indicating success or failure (does not throw C++ exceptions)
         */
        inline HRESULT get_value_expanded_string_nothrow(HKEY key, _In_opt_ PCWSTR value_name,
                                                         ::wil::unique_bstr &return_value) WI_NOEXCEPT
        {
         ...
         * @param value_name The name of the registry value whose data is to be read.
         *        Can be nullptr to read from the unnamed default registry value.
         * @param[out] return_value A ::wil::unique_cotaskmem_array_ptr<::wil::unique_cotaskmem_string> receiving the
            ...
            ::wil::unique_cotaskmem_array_ptr<::wil::unique_cotaskmem_string> &return_value) WI_NOEXCEPT
        {
            ...
            if (!rawData.empty())
            {
                auto *const begin = reinterpret_cast<wchar_t *>(rawData.data());
                auto *const end = begin + rawData.size() / sizeof(wchar_t);
                ::wil::reg::reg_view_details::get_cotaskmemstring_array_from_multistring_nothrow(begin, end,
                                                                                                 return_value);
            }
            return S_OK;
        }
    ...
    // auto watcher = wil::make_registry_watcher(HKEY_CURRENT_USER, L"Software\\MyApp", true, wil::RegistryChangeKind
    // changeKind[]
    //     {
    ...
    // auto watcher = wil::make_registry_watcher_nothrow(HKEY_CURRENT_USER, L"Software\\MyApp", true,
    ...
    namespace details
    {
        ...
        {
            registry_watcher_state(unique_hkey &&keyToWatch, bool isRecursive,
                                   wistd::function<void(RegistryChangeKind)> &&callback)
        ...
        typedef resource_policy<registry_watcher_state *, decltype(&details::delete_registry_watcher_state),
                                details::delete_registry_watcher_state, details::pointer_access_none>
    ...
    class registry_watcher_t : public storage_t
    {
      public:
        ...
        registry_watcher_t(HKEY rootKey, _In_ PCWSTR subKey, bool isRecursive,
                           wistd::function<void(RegistryChangeKind)> &&callback)
        {
            static_assert(wistd::is_same<void, result>::value,
                          "this constructor requires exceptions; use the create method");
            create(rootKey, subKey, isRecursive, wistd::move(callback));
        }

        registry_watcher_t(unique_hkey &&keyToWatch, bool isRecursive,
                           wistd::function<void(RegistryChangeKind)> &&callback)
        {
            static_assert(wistd::is_same<void, result>::value,
                          "this constructor requires exceptions; use the create method");
        ...
        result create(HKEY rootKey, _In_ PCWSTR subKey, bool isRecursive,
                      wistd::function<void(RegistryChangeKind)> &&callback)
        {
            ...
            HRESULT hr = HRESULT_FROM_WIN32(
                RegCreateKeyExW(rootKey, subKey, 0, nullptr, 0, KEY_NOTIFY, nullptr, &keyToWatch, nullptr));
            if (FAILED(hr))
            {
...
#define __WIL_REGISTRY_CHANGE_CALLBACK_TEST
        ...
        HRESULT create_common(unique_hkey &&keyToWatch, bool isRecursive,
                              wistd::function<void(RegistryChangeKind)> &&callback)
        {
            wistd::unique_ptr<details::registry_watcher_state> watcherState(
                new (std::nothrow)
                    details::registry_watcher_state(wistd::move(keyToWatch), isRecursive, wistd::move(callback)));
            RETURN_IF_NULL_ALLOC(watcherState);
            RETURN_IF_FAILED(watcherState->m_eventHandle.create());
            RETURN_IF_WIN32_ERROR(RegNotifyChangeKeyValue(watcherState->m_keyToWatch.get(), watcherState->m_isRecursive,
                                                          REG_NOTIFY_CHANGE_LAST_SET | REG_NOTIFY_CHANGE_NAME |
                                                              REG_NOTIFY_THREAD_AGNOSTIC,
                                                          watcherState->m_eventHandle.get(), TRUE));

            watcherState->m_threadPoolWait.reset(
                CreateThreadpoolWait(&registry_watcher_t::callback, watcherState.get(), nullptr));
    ...
    typedef unique_any_t<registry_watcher_t<details::unique_storage<details::registry_watcher_state_resource_policy>,
                                            err_returncode_policy>>
        unique_registry_watcher_nothrow;
    typedef unique_any_t<registry_watcher_t<details::unique_storage<details::registry_watcher_state_resource_policy>,
                                            err_failfast_policy>>
        unique_registry_watcher_failfast;

    inline unique_registry_watcher_nothrow make_registry_watcher_nothrow(
        HKEY rootKey, _In_ PCWSTR subKey, bool isRecursive,
        wistd::function<void(RegistryChangeKind)> &&callback) WI_NOEXCEPT
    {
    ...
    inline unique_registry_watcher make_registry_watcher(HKEY rootKey, _In_ PCWSTR subKey, bool isRecursive,
                                                         wistd::function<void(RegistryChangeKind)> &&callback)
    {
        return unique_registry_watcher(rootKey, subKey, isRecursive, wistd::move(callback));
    }

    inline unique_registry_watcher make_registry_watcher(unique_hkey &&keyToWatch, bool isRecursive,
                                                         wistd::function<void(RegistryChangeKind)> &&callback)
    {
