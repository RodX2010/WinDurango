...
namespace wistd // ("Windows Implementation" std)
{
    ...
    template <class _Tp, bool> struct __WI_LIBCPP_TEMPLATE_VIS __dependent_type : public _Tp
    {
    };

    template <bool _Bp, class _If, class _Then> struct __WI_LIBCPP_TEMPLATE_VIS conditional
    {
        typedef _If type;
    };
    template <class _If, class _Then> struct __WI_LIBCPP_TEMPLATE_VIS conditional<false, _If, _Then>
    {
        typedef _Then type;
    };
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS __lazy_enable_if<true, _Tp>
    {
        typedef typename _Tp::type type;
    };

    template <bool, class _Tp = void> struct __WI_LIBCPP_TEMPLATE_VIS enable_if{};
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS enable_if<true, _Tp>
    {
        typedef _Tp type;
    };
...
// addressof
    ...
    template <class _Tp>
    inline __WI_LIBCPP_CONSTEXPR_AFTER_CXX14 __WI_LIBCPP_NO_CFI __WI_LIBCPP_INLINE_VISIBILITY _Tp *addressof(_Tp &__x)
        WI_NOEXCEPT
    {
    ...
    template <class _Tp> inline __WI_LIBCPP_NO_CFI __WI_LIBCPP_INLINE_VISIBILITY _Tp *addressof(_Tp &__x) WI_NOEXCEPT
    {
    ...
    template <class _Tp, _Tp __v> struct __WI_LIBCPP_TEMPLATE_VIS integral_constant
    {
        static __WI_LIBCPP_CONSTEXPR const _Tp value = __v;
        typedef _Tp value_type;
        typedef integral_constant type;
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR
        operator value_type() const WI_NOEXCEPT
        {
            return value;
        }
#if __WI_LIBCPP_STD_VER > 11
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_INLINE_VISIBILITY constexpr value_type operator()() const
            WI_NOEXCEPT
        {
            return value;
        }
    ...
    template <class _Tp, _Tp __v> __WI_LIBCPP_CONSTEXPR const _Tp integral_constant<_Tp, __v>::value;
...
#define __WI_LIBCPP_BOOL_CONSTANT(__b) integral_constant<bool, (__b)>
    ...
    template <class _B0, class _B1> struct __and_<_B0, _B1> : conditional<_B0::value, _B1, _B0>::type
    {
    };
    ...
    template <class _B0, class _B1> struct __or_<_B0, _B1> : conditional<_B0::value, _B0, _B1>::type
    {
    };
    ...
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_const_v = is_const<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_volatile_v = is_volatile<_Tp>::value;
#endif

    // remove_const

    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_const
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_const<const _Tp>
    {
        typedef _Tp type;
    };
#if __WI_LIBCPP_STD_VER > 11
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_volatile
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_volatile<volatile _Tp>
    {
        typedef _Tp type;
    };
#if __WI_LIBCPP_STD_VER > 11
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_void_v = is_void<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_integral_v = is_integral<_Tp>::value;
#endif
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_array : public false_type
    {
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_array<_Tp[]> : public true_type
    {
    };
    template <class _Tp, size_t _Np> struct __WI_LIBCPP_TEMPLATE_VIS is_array<_Tp[_Np]> : public true_type
    {
    };

#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_array_v = is_array<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_pointer_v = is_pointer<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_reference_v = is_reference<_Tp>::value;
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_union : public integral_constant<bool, __is_union(_Tp)>
    {
    };
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_union : public __libcpp_union<typename remove_cv<_Tp>::type>
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_union_v = is_union<_Tp>::value;
#endif
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_class : public integral_constant<bool, __is_class(_Tp)>
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_class_v = is_class<_Tp>::value;
#endif
    ...
    template <class _Tp, bool = is_class<_Tp>::value || is_union<_Tp>::value || is_void<_Tp>::value ||
                                is_reference<_Tp>::value || __is_nullptr_t<_Tp>::value>
    struct __libcpp_is_function : public integral_constant<bool, sizeof(__libcpp_is_function_imp::__test<_Tp>(
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_function : public __libcpp_is_function<_Tp>
    {
    };

#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_function_v = is_function<_Tp>::value;
#endif
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_enum : public integral_constant<bool, __is_enum(_Tp)>
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_enum_v = is_enum<_Tp>::value;
#endif

    // is_arithmetic

    template <class _Tp>
    struct __WI_LIBCPP_TEMPLATE_VIS is_arithmetic
        : public integral_constant<bool, is_integral<_Tp>::value || is_floating_point<_Tp>::value>
    {
    };

#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_arithmetic_v = is_arithmetic<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_scalar_v = is_scalar<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_object_v = is_object<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_compound_v = is_compound<_Tp>::value;
#endif
    ...
    struct __is_referenceable
        : integral_constant<bool, !is_same<decltype(__is_referenceable_impl::__test<_Tp>(0)), __two>::value>{};
    ...
    template <class _Tp> struct __add_const<_Tp, false>
    {
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_reference
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_reference<_Tp &>
    {
        typedef _Tp type;
    };
#ifndef __WI_LIBCPP_HAS_NO_RVALUE_REFERENCES
...
// MSVC has issues compiling some source code that uses the libc++ definition of 'declval'
#ifdef _MSC_VER
    template <typename _Tp> typename add_rvalue_reference<_Tp>::type declval() WI_NOEXCEPT;
#else
    template <class _Tp> _Tp &&__declval(int);
    template <class _Tp> _Tp __declval(long);

    template <class _Tp> decltype(__declval<_Tp>(0)) declval() WI_NOEXCEPT;
#endif
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_pointer
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_pointer<_Tp *>
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_pointer<_Tp *const>
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_pointer<_Tp *volatile>
    {
        typedef _Tp type;
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS remove_pointer<_Tp *const volatile>
    {
        typedef _Tp type;
    };
...
// type_identity
    ...
    template <class _Tp> struct __libcpp_is_signed_impl<_Tp, false> : public true_type
    {
    }; // floating point
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_signed_v = is_signed<_Tp>::value;
#endif
    ...
    template <class _Tp> struct __libcpp_is_unsigned_impl<_Tp, false> : public false_type
    {
    }; // floating point
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_unsigned_v = is_unsigned<_Tp>::value;
#endif

    // rank

    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS rank : public integral_constant<size_t, 0>
    {
    };
    template <class _Tp>
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR size_t rank_v = rank<_Tp>::value;
#endif

    // extent

    template <class _Tp, unsigned _Ip = 0> struct __WI_LIBCPP_TEMPLATE_VIS extent : public integral_constant<size_t, 0>
    {
    };
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS extent<_Tp[], 0> : public integral_constant<size_t, 0>
    {
    };
    ...
    struct __WI_LIBCPP_TEMPLATE_VIS extent<_Tp[_Np], _Ip>
    ...
    {
      public:
        typedef typename conditional<is_array<_Up>::value, typename remove_extent<_Up>::type *,
                                     typename conditional<is_function<_Up>::value, typename add_pointer<_Up>::type,
                                                          typename remove_cv<_Up>::type>::type>::type type;
    };

    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS decay
    {
      private:
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_abstract_v = is_abstract<_Tp>::value;
#endif
...
#else
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS __libcpp_is_final : public false_type
    {
    };
#endif

#if defined(__WI_LIBCPP_HAS_IS_FINAL) && __WI_LIBCPP_STD_VER > 11
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_final : public integral_constant<bool, __is_final(_Tp)>
    {
    };
#endif

#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_final_v = is_final<_Tp>::value;
#endif
...
// is_aggregate
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR constexpr bool is_aggregate_v = is_aggregate<_Tp>::value;
#endif
    ...
    {
        template <class _Tp> struct _Dst
        {
            _Dst(const volatile _Tp &);
        };
        template <class _Tp> struct _Src
        {
            operator const volatile _Tp &();
            template <class _Up> operator const _Dst<_Up> &();
        };
        template <size_t> struct __one
        {
            typedef char type;
        };
    ...
    namespace __is_convertible_imp
    {
        ...
        struct __is_convertible_test<_From, _To, decltype(__is_convertible_imp::__test_convert<_To>(declval<_From>()))>
            : public true_type
        {
        };
    ...
    template <class _Tp> struct __is_convertible_check<_Tp, 0>
    {
    ...
    struct __is_convertible
        : public integral_constant<
              bool, __is_convertible_imp::__is_convertible_test<_T1, _T2>::value
    ...
    template <class _T1, class _T2> struct __WI_LIBCPP_TEMPLATE_VIS is_convertible : public __is_convertible<_T1, _T2>
    {
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_empty : public integral_constant<bool, __is_empty(_Tp)>
    {
    };

#else // __WI_HAS_FEATURE_IS_EMPTY

    template <class _Tp> struct __is_empty1 : public _Tp
    {
        double __lx;
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_empty_v = is_empty<_Tp>::value;
#endif
    ...
    template <class _Tp>
    struct __WI_LIBCPP_TEMPLATE_VIS has_virtual_destructor
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS has_virtual_destructor : public false_type
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR size_t alignment_of_v = alignment_of<_Tp>::value;
#endif
    ...
    {
        typedef
            typename conditional<_Align == _Hp::value, typename _Hp::type, typename __find_pod<_Tp, _Align>::type>::type
                type;
    };

    template <size_t _Align>
    struct __has_pod_with_align
        : public integral_constant<bool, !is_same<typename __find_pod<__all_types, _Align>::type, void>::value>
    {
    };
    ...
    template <size_t _Len, size_t _Align, bool = __has_pod_with_align<_Align>::value> struct __aligned_storage
    {
...
#define __WI_CREATE_ALIGNED_STORAGE_SPECIALIZATION(n)                                                                  \
    template <size_t _Len> struct __aligned_storage<_Len, n, false>                                                    \
    {                                                                                                                  \
...
#undef __WI_CREATE_ALIGNED_STORAGE_SPECIALIZATION
    ...
    template <> struct __make_signed<signed short, true>
    {
        typedef short type;
    };
    ...
    template <> struct __make_signed<signed int, true>
    {
        typedef int type;
    };
    ...
    template <> struct __make_signed<signed long, true>
    {
        typedef long type;
    };
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS make_signed
    {
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS make_unsigned
    {
    ...
    template <class _Tp, class _Up = void, class _Vp = void> struct __WI_LIBCPP_TEMPLATE_VIS common_type
    {
      public:
        typedef typename common_type<typename common_type<_Tp, _Up>::type, _Vp>::type type;
    };

    template <> struct __WI_LIBCPP_TEMPLATE_VIS common_type<void, void, void>
    {
      public:
        typedef void type;
    };

    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS common_type<_Tp, void, void>
    {
      public:
        typedef typename common_type<_Tp, _Tp>::type type;
    };

    template <class _Tp, class _Up> struct __WI_LIBCPP_TEMPLATE_VIS common_type<_Tp, _Up, void>
    {
    ...
    template <class... _Tp> struct __WI_LIBCPP_TEMPLATE_VIS common_type{};

    // bullet 2 - sizeof...(Tp) == 1

    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS common_type<_Tp> : public common_type<_Tp, _Tp>
    {
    };
    ...
    using __common_type2 = typename conditional<is_same<_Tp, _DTp>::value && is_same<_Up, _DUp>::value,
                                                __common_type2_imp<_Tp, _Up>, common_type<_DTp, _DUp>>::type;

    template <class _Tp, class _Up> struct __WI_LIBCPP_TEMPLATE_VIS common_type<_Tp, _Up> : __common_type2<_Tp, _Up>
    {
    };
    ...
    template <class _Tp> struct is_destructible : public integral_constant<bool, __is_destructible(_Tp)>
    {
    };
    ...
    template <class _Tp>
    inline __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR typename remove_reference<_Tp>::type &&move(_Tp &&__t)
        WI_NOEXCEPT
    {
        typedef typename remove_reference<_Tp>::type _Up;
    ...
    template <class _Tp>
    inline __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR _Tp &&forward(typename remove_reference<_Tp>::type &__t)
        WI_NOEXCEPT
    {
    ...
    template <class _Tp> inline __WI_LIBCPP_INLINE_VISIBILITY _Tp &move(_Tp &__t)
    {
        return __t;
    }

    template <class _Tp> inline __WI_LIBCPP_INLINE_VISIBILITY const _Tp &move(const _Tp &__t)
    {
        return __t;
    }
...
#if __WI_LIBCPP_STD_VER > 11
    template <> struct __WI_LIBCPP_TEMPLATE_VIS less<void>
    {
        template <class _T1, class _T2>
        __WI_LIBCPP_NODISCARD_ATTRIBUTE __WI_LIBCPP_CONSTEXPR_AFTER_CXX11 __WI_LIBCPP_INLINE_VISIBILITY auto operator()(
            _T1 &&__t, _T2 &&__u) const __WI_NOEXCEPT_(noexcept(wistd::forward<_T1>(__t) < wistd::forward<_T2>(__u)))
    ...
    template <class _Tp> inline __WI_LIBCPP_INLINE_VISIBILITY typename decay<_Tp>::type __decay_copy(_Tp &&__t)
    {
    ...
    template <class _Tp> inline __WI_LIBCPP_INLINE_VISIBILITY typename decay<_Tp>::type __decay_copy(const _Tp &__t)
    {
        return wistd::forward<_Tp>(__t);
    }
    ...
    template <class _Rp, class _Class> struct __member_pointer_traits_imp<_Rp (_Class::*)(), true, false>
    {
        typedef _Class _ClassType;
        typedef _Rp _ReturnType;
        typedef _Rp(_FnType)();
    ...
    template <class _Rp, class _Class, class _P0> struct __member_pointer_traits_imp<_Rp (_Class::*)(_P0), true, false>
    {
        typedef _Class _ClassType;
        typedef _Rp _ReturnType;
    ...
    template <class _Rp, class _Class> struct __member_pointer_traits_imp<_Rp (_Class::*)() const, true, false>
    {
        typedef _Class const _ClassType;
        typedef _Rp _ReturnType;
        typedef _Rp(_FnType)();
    ...
    template <class _Rp, class _Class> struct __member_pointer_traits_imp<_Rp (_Class::*)() volatile, true, false>
    {
        typedef _Class volatile _ClassType;
        typedef _Rp _ReturnType;
        typedef _Rp(_FnType)();
    ...
    template <class _Rp, class _Class> struct __member_pointer_traits_imp<_Rp (_Class::*)() const volatile, true, false>
    {
        typedef _Class const volatile _ClassType;
        typedef _Rp _ReturnType;
        typedef _Rp(_FnType)();
...
#if !defined(__WI_LIBCPP_CXX03_LANG) &&                                                                                \
    (!__WI_HAS_FEATURE_IS_CONSTRUCTIBLE || defined(__WI_LIBCPP_TESTING_FALLBACK_IS_CONSTRUCTIBLE))
    ...
    template <class _To, class _From> struct __is_invalid_base_to_derived_cast
    {
        ...
        static const bool value = __lazy_and<__lazy_not<is_same<_RawFrom, _RawTo>>, is_base_of<_RawFrom, _RawTo>,
                                             __lazy_not<__libcpp_is_constructible<_RawTo, _From>>>::value;
    };
    ...
    template <class _ToRef, class _FromRef> struct __is_invalid_lvalue_to_rvalue_cast<_ToRef &&, _FromRef &>
    {
        ...
        static const bool value = __lazy_and<__lazy_not<is_function<_RawTo>>,
                                             __lazy_or<is_same<_RawFrom, _RawTo>, is_base_of<_RawTo, _RawFrom>>>::value;
    };
    ...
    template <class _Tp> decltype((_Tp(), true_type())) __is_constructible0_test(_Tp &);

    false_type __is_constructible0_test(__any);

    template <class _Tp, class _A0> decltype((_Tp(declval<_A0>()), true_type())) __is_constructible1_test(_Tp &, _A0 &);

    template <class _A0> false_type __is_constructible1_test(__any, _A0 &);

    template <class _Tp, class _A0, class _A1>
    decltype((_Tp(declval<_A0>(), declval<_A1>()), true_type())) __is_constructible2_test(_Tp &, _A0 &, _A1 &);

    template <class _A0, class _A1> false_type __is_constructible2_test(__any, _A0 &, _A1 &);

    template <class _Tp, class _A0, class _A1, class _A2>
    decltype((_Tp(declval<_A0>(), declval<_A1>(), declval<_A2>()), true_type())) __is_constructible3_test(_Tp &, _A0 &,
                                                                                                          _A1 &, _A2 &);

    template <class _A0, class _A1, class _A2> false_type __is_constructible3_test(__any, _A0 &, _A1 &, _A2 &);
    ...
    struct __is_constructible3_imp // false, _Tp is not a scalar
        : public common_type<decltype(__is_constructible3_test(declval<_Tp &>(), declval<_A0>(), declval<_A1>(),
                                                               declval<_A2>()))>::type
    {
    };
    ...
    template <class _Tp> struct __is_constructible0_imp<true, _Tp> : public is_scalar<_Tp>
    {
    };

    template <class _Tp, class _A0> struct __is_constructible1_imp<true, _Tp, _A0> : public is_convertible<_A0, _Tp>
    {
    };

    template <class _Tp, class _A0, class _A1> struct __is_constructible2_imp<true, _Tp, _A0, _A1> : public false_type
    {
    };
    ...
    struct __is_constructible0_void_check
        : public __is_constructible0_imp<is_scalar<_Tp>::value || is_reference<_Tp>::value, _Tp>
    {
    };

    template <bool, class _Tp, class _A0>
    struct __is_constructible1_void_check
        : public __is_constructible1_imp<is_scalar<_Tp>::value || is_reference<_Tp>::value, _Tp, _A0>
    {
    };
    ...
    template <class _Tp> struct __is_constructible0_void_check<true, _Tp> : public false_type
    {
    };

    template <class _Tp, class _A0> struct __is_constructible1_void_check<true, _Tp, _A0> : public false_type
    {
    };
    ...
    struct __WI_LIBCPP_TEMPLATE_VIS is_constructible
        : public __is_constructible3_void_check<is_void<_Tp>::value || is_abstract<_Tp>::value ||
                                                    is_function<_Tp>::value || is_void<_A0>::value ||
                                                    is_void<_A1>::value || is_void<_A2>::value,
                                                _Tp, _A0, _A1, _A2>
    {
    };
    ...
    struct __WI_LIBCPP_TEMPLATE_VIS is_constructible<_Tp, __is_construct::__nat, __is_construct::__nat>
        : public __is_constructible0_void_check<
              is_void<_Tp>::value || is_abstract<_Tp>::value || is_function<_Tp>::value, _Tp>
    {
    };

    template <class _Tp, class _A0>
    struct __WI_LIBCPP_TEMPLATE_VIS is_constructible<_Tp, _A0, __is_construct::__nat>
        : public __is_constructible1_void_check<is_void<_Tp>::value || is_abstract<_Tp>::value ||
                                                    is_function<_Tp>::value || is_void<_A0>::value,
                                                _Tp, _A0>
    {
    };
    ...
    struct __WI_LIBCPP_TEMPLATE_VIS is_constructible<_Tp, _A0, _A1, __is_construct::__nat>
        : public __is_constructible2_void_check<is_void<_Tp>::value || is_abstract<_Tp>::value ||
                                                    is_function<_Tp>::value || is_void<_A0>::value ||
                                                    is_void<_A1>::value,
                                                _Tp, _A0, _A1>
    {
    ...
    template <class _Ap, size_t _Np, class _A0> struct __is_constructible1_imp<false, _Ap[_Np], _A0> : public false_type
    {
    };
    ...
    template <class _Ap> struct __is_constructible0_imp<false, _Ap[]> : public false_type
    {
    };

    template <class _Ap, class _A0> struct __is_constructible1_imp<false, _Ap[], _A0> : public false_type
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES) &&                                     \
    !defined(__WI_LIBCPP_HAS_NO_VARIADICS)
    template <class _Tp, class... _Args>
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_default_constructible : public is_constructible<_Tp>
    {
    };
    ...
    template <class _Tp, class... _Args> struct __WI_LIBCPP_TEMPLATE_VIS is_trivially_constructible : false_type
    {
    };
    ...
    template <class _Tp>
    struct __WI_LIBCPP_TEMPLATE_VIS is_trivially_move_assignable
        : public is_trivially_assignable<typename add_lvalue_reference<_Tp>::type,
#ifndef __WI_LIBCPP_HAS_NO_RVALUE_REFERENCES
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_trivially_destructible<_Tp[]> : public false_type
    {
    };
    ...
    template <class _Tp, class... _Args> struct __WI_LIBCPP_TEMPLATE_VIS is_nothrow_constructible : false_type
    {
    };
    ...
    template <class _Tp, class _Arg> struct __WI_LIBCPP_TEMPLATE_VIS is_nothrow_assignable : public false_type
    {
    };
    ...
    template <class _Tp>
    struct __WI_LIBCPP_TEMPLATE_VIS is_nothrow_move_assignable
        : public is_nothrow_assignable<typename add_lvalue_reference<_Tp>::type,
#ifndef __WI_LIBCPP_HAS_NO_RVALUE_REFERENCES
                                       typename add_rvalue_reference<_Tp>::type>
#else
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_nothrow_destructible<_Tp &> : public true_type
    {
    };
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_nothrow_destructible<_Tp[]> : public false_type
    {
    };
    ...
    template <class _Tp> struct __WI_LIBCPP_TEMPLATE_VIS is_pod : public integral_constant<bool, __is_pod(_Tp)>
    {
    };
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_pod_v = is_pod<_Tp>::value;
#endif
...
#if __WI_LIBCPP_STD_VER > 11 && !defined(__WI_LIBCPP_HAS_NO_VARIABLE_TEMPLATES)
    template <class _Tp> __WI_LIBCPP_INLINE_VAR __WI_LIBCPP_CONSTEXPR bool is_trivial_v = is_trivial<_Tp>::value;
#endif
    ...
    template <class _Fp, class _A0, class _DecayFp = typename decay<_Fp>::type,
              class _DecayA0 = typename decay<_A0>::type>
    using __enable_if_bullet2 = typename enable_if<is_member_function_pointer<_DecayFp>::value &&
...
#define __WI_LIBCPP_INVOKE_RETURN(...)                                                                                 \
    ...
    inline __WI_LIBCPP_INLINE_VISIBILITY auto __invoke(_Fp &&__f, _A0 &&__a0, _Args &&...__args)
        ...
        auto __invoke(_Fp &&__f, _A0 &&__a0) __WI_LIBCPP_INVOKE_RETURN(wistd::forward<_A0>(__a0).*__f)
            ...
            inline __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR auto __invoke_constexpr(_Fp &&__f, _A0 &&__a0)
                __WI_LIBCPP_INVOKE_RETURN(wistd::forward<_A0>(__a0).*__f)
                    ...
                    inline __WI_LIBCPP_INLINE_VISIBILITY
        auto __invoke(_Fp &&__f, _A0 &&__a0) __WI_LIBCPP_INVOKE_RETURN(__a0.get().*__f)
...
#undef __WI_LIBCPP_INVOKE_RETURN
    ...
    template <class _Fn, class... _Args> struct __WI_LIBCPP_TEMPLATE_VIS invoke_result : __invoke_of<_Fn, _Args...>
    {
    };
    ...
    inline __WI_LIBCPP_INLINE_VISIBILITY
        ...
        void
#endif
        swap_wil(_Tp &__x, _Tp &__y)
            __WI_NOEXCEPT_(is_nothrow_move_constructible<_Tp>::value &&is_nothrow_move_assignable<_Tp>::value)
    {
    ...
    inline __WI_LIBCPP_INLINE_VISIBILITY _ForwardIterator2 swap_ranges_wil(_ForwardIterator1 __first1,
    ...
    template <class _Tp, size_t _Np>
    inline __WI_LIBCPP_INLINE_VISIBILITY typename enable_if<__is_swappable<_Tp>::value>::type swap_wil(_Tp (&__a)[_Np],
                                                                                                       _Tp (&__b)[_Np])
    ...
    template <class _Tp> __WI_LIBCPP_INLINE_VAR constexpr bool is_swappable_v = is_swappable<_Tp>::value;
    ...
    template <class _Tp, bool _Support = false> struct underlying_type
    {
    ...
    inline __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR unsigned long long __convert_to_integral(
    ...
    template <class _Tp>
    inline __WI_LIBCPP_INLINE_VISIBILITY __WI_LIBCPP_CONSTEXPR typename __sfinae_underlying_type<_Tp>::__promoted_type
    ...
    template <class... _Args> __WI_LIBCPP_INLINE_VAR constexpr bool conjunction_v = conjunction<_Args...>::value;

    template <class... _Args> struct disjunction : __or_<_Args...>
    {
    };
    template <class... _Args> __WI_LIBCPP_INLINE_VAR constexpr bool disjunction_v = disjunction<_Args...>::value;

    template <class _Tp> struct negation : __not_<_Tp>
    {
    };
    template <class _Tp> __WI_LIBCPP_INLINE_VAR constexpr bool negation_v = negation<_Tp>::value;
#endif // __WI_LIBCPP_HAS_NO_VARIADICS
#endif // __WI_LIBCPP_CXX03_LANG
...
// These traits are used in __tree and __hash_table
    ...
    struct __can_extract_key
        : conditional<is_same<_RawValTy, _Key>::value, __extract_key_self_tag, __extract_key_fail_tag>::type
    {
    };

    template <class _Pair, class _Key, class _First, class _Second>
    struct __can_extract_key<_Pair, _Key, pair<_First, _Second>>
        : conditional<is_same<typename remove_const<_First>::type, _Key>::value, __extract_key_first_tag,
